<%@ Page Language="C#" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master" AutoEventWireup="true"
    CodeFile="SpareConsumptionSummary.aspx.cs" Inherits="SIMS_Reports_SpareConsumptionSummary"
    ...
    <asp:UpdatePanel ID="updatepnl" runat="server">
        ...
        <ContentTemplate>
            <table width="100%">
                <tr>
                    <td class="headingred">
                        Spare Consumption Summary Report
                    </td>
                        ...
                        <table width="98%" border="0">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlASC"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        PagerStyle-HorizontalAlign="Center" AllowSorting="True" AutoGenerateColumns="true"
                                        ID="gvComm" runat="server" OnPageIndexChanging="gvComm_PageIndexChanging" Width="100%"
                                        HorizontalAlign="Left" Visible="true" OnSorting="gvComm_Sorting" HeaderStyle-HorizontalAlign="Left" AlternatingRowStyle-HorizontalAlign="Left" RowStyle-HorizontalAlign="Left">
                                        <%--<Columns>
                                    ...
                                    <!-- End Action Listing -->
                                    <asp:GridView ID="gvExport" HeaderStyle-HorizontalAlign="Left" AutoGenerateColumns="true" runat="server">
                                    </asp:GridView>
                                </td>
                            </tr>
                            <tr>
