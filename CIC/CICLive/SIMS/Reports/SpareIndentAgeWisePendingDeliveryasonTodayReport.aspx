<%@ Page Language="C#" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master" AutoEventWireup="true"
    CodeFile="SpareIndentAgeWisePendingDeliveryasonTodayReport.aspx.cs" Inherits="Reports_SpareIndentAgeWisePendingDeliveryasonTodayReport"
    Title="Spare Indent AgeWise Pending Delivery as on Today Report" EnableEventValidation="false" %>
   ...
   <asp:UpdatePanel ID="updatepnl" runat="server">
        ...
        <ContentTemplate>
            <table width="100%">
                <tr>
                    <td class="headingred">
                        Spare Indent Age Wise Pending Delivery Report
                    </td>
                    ...
                    <td style="padding: 10px" align="center" colspan="2">
                        <table width="98%" border="0">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox runat="server" ID="txtFromDate" Width="85px" CssClass="txtboxtxt" ValidationGroup="editt"
                                        MaxLength="10" />
                                    ...
                                    To
                                    <asp:TextBox runat="server"  Width="85px" ID="txtToDate" CssClass="txtboxtxt" ValidationGroup="editt"
                                        MaxLength="10" />
                        ...
                        <table width="100%" border="0">
                            <tr>
                                <td>
                                    <!-- Action Listing -->
                                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName" HeaderStyle-CssClass="fieldNamewithbgcolor"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Indent No" SortExpression="Indent No" HeaderStyle-Width="100px"
                                               ...
                                               <asp:BoundField DataField="Date" SortExpression="Date"
                                                ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderText="Date">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>                                         
                                            ...
                                            <asp:BoundField DataField="Total Ordered" SortExpression="Total Ordered"
                                                ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderText="Total Ordered">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Schedule Ordered" SortExpression="Schedule Ordered" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Schedule Ordered">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Dispatched" SortExpression="Dispatched" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Dispatched">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Recieved" SortExpression="Recieved" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Recieved">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Total Pending" SortExpression="Total Pending" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Total Pending">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="Total Pending" SortExpression="Total Pending" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Over Due Pending">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                        </Columns>
