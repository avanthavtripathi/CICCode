<%@ Page Language="C#" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master" 
AutoEventWireup="true" CodeFile="SpareRpt.aspx.cs" Inherits="SIMS_Reports_SpareRpt" 
Title="Spare Sheet" EnableEventValidation="false" %>
                                ...
                                <table width="100%" align="center">
                                    <tr>
                                        ...
                                        <asp:GridView RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                            ...
                                            DataKeyNames="Spare_Id" AutoGenerateColumns="False" ID="gvComm"
                                        ...
                                        <!-- End Batch Listing -->
                                        <asp:GridView GridGroups="both" AutoGenerateColumns="false" ID="GvExcel"
                                            runat="server" Width="100%" >
                                             <Columns>
                                                <asp:BoundField DataField="Sno" HeaderStyle-Width="40px" HeaderText="SNo" />
                                                <asp:BoundField DataField="Division" HeaderStyle-Width="60px" HeaderText="Division" />
                                                <asp:BoundField DataField="SAP_Code" HeaderText="Spare Code" />
                                                <asp:BoundField DataField="SAP_Desc" HeaderText="Spare Desciption" />
                                                <asp:BoundField DataField="SAP_UOM" HeaderText="Unit of Measurement" />
                                                <asp:BoundField DataField="SAP_ListPrice" HeaderText="List Price" />
                                                <asp:BoundField DataField="Discount" HeaderText="Discount %" />
                                                <asp:BoundField DataField="SAP_MatGroup" HeaderText="Material Group" />
                                                <asp:BoundField DataField="SAP_MatType" HeaderText="Material Type" />                                               
                                                <asp:BoundField DataField="Spare_Mov_Type" HeaderText="Spare Moving Type" />
                                                <asp:BoundField DataField="Spare_Value" HeaderText="Spare Value" />                                            
                                                <asp:BoundField DataField="Spare_Type" HeaderText="Spare Type" />
                                                <asp:BoundField DataField="Spare_MOQ" HeaderText="Minimum Order Quantity" />
                                                <asp:BoundField DataField="FileView" HeaderText="Photograph" />                                                               
                                                <asp:BoundField DataField="Spare_Disposal_Flag" HeaderText="Spare disposal/ Destruction Type" />
                                                <asp:BoundField DataField="Spare_Action_By_CG" HeaderText="Spare Action by CG Branch" />
                                                <asp:BoundField DataField="Essential_Spare" HeaderText="Essential Spare" />
                                                <asp:BoundField DataField="Spare_Obselete" HeaderText="Spare Obselete" />
                                  ...
                                  <tr>
                                    <td>
                                        <asp:Button CssClass="btn" ID="btnExportToExcela" runat="server" Text="Save To Excel" OnClick="btnExportToExcel_Click" />
                                    </td>
                                </tr>
