...
public partial class SIMS_Reports_SpareStockSummary : System.Web.UI.Page
{
    SpareStockSummary objSpareStockSummary = new SpareStockSummary();
        ...
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    objSpareStockSummary.ASC_Id = 0;
                    objSpareStockSummary.BindProductDivisionData(ddlProductDivison);
                }
                objSpareStockSummary.ProductDivision_Id = 0;
                objSpareStockSummary.BindSpareCodeData(ddlSpareCode);
    ...
    protected void ddlASC_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            objSpareStockSummary.ASC_Id = Convert.ToInt32(ddlASC.SelectedValue);
            objSpareStockSummary.BindProductDivisionData(ddlProductDivison);
        }
        catch (Exception ex)
        {
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=SpareStockSummary.xls");
        Response.ContentType = "application/ms-excel";
        System.IO.StringWriter stringWrite = new System.IO.StringWriter();
        System.Web.UI.HtmlTextWriter htmlWrite = new HtmlTextWriter(stringWrite);
        DataSet dsExport = new DataSet();
        objSpareStockSummary.ASC_Id = Convert.ToInt32(ddlASC.SelectedValue);
        objSpareStockSummary.ProductDivision_Id = Convert.ToInt32(ddlProductDivison.SelectedValue);
        objSpareStockSummary.Spare_Id = Convert.ToInt32(ddlSpareCode.SelectedValue);
        objSpareStockSummary.From_Date = Convert.ToString(txtFromDate.Text.Trim());
        objSpareStockSummary.To_Date = Convert.ToString(txtToDate.Text.Trim());
        dsExport = objSpareStockSummary.BindData(gvExport);
    ...
    private void BindData(string strOrder)
    {
        ...
        //objSpareStockSummary.Region_Sno = Convert.ToInt32(ddlRegion.SelectedValue);
        //objSpareStockSummary.Branch_SNo = Convert.ToInt32(ddlBranch.SelectedValue);
        objSpareStockSummary.ASC_Id = Convert.ToInt32(ddlASC.SelectedValue);
        objSpareStockSummary.ProductDivision_Id = Convert.ToInt32(ddlProductDivison.SelectedValue);
        objSpareStockSummary.Spare_Id = Convert.ToInt32(ddlSpareCode.SelectedValue);
        objSpareStockSummary.From_Date = Convert.ToString(txtFromDate.Text.Trim());
        objSpareStockSummary.To_Date = Convert.ToString(txtToDate.Text.Trim());
        dstData = objSpareStockSummary.BindData(gvComm);
