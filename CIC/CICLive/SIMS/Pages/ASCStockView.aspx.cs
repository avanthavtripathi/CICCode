...
public partial class SIMS_Pages_ASCStockView : System.Web.UI.Page
{
    ...
    protected void gvComm_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        sbmain.Append(" INNER JOIN CIC_IS.dbo.MstUnit MU ON MU.UNIT_SNO=SL.PRODUCTDIVISION_ID");
        sbmain.Append(" INNER JOIN MSTBASICSPARE BS ON BS.SPARE_ID=SL.SPARE_ID where SL.ASC_ID=(select sc_sno from CIC_IS.dbo.MstServiceContractor where sc_username='" + Membership.GetUser().UserName.ToString() + "' )and AL.loc_code='main' and SL.qty>0 AND   SL.productdivision_id='" + ddlproddiv.SelectedValue + "')as tbl group by SPARE");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ddlproddiv.SelectedIndex > 0)
            {
                ...
                sbdefrcpt.Append(" and DSA.asc_id=(select sc_sno from CIC_IS.dbo.MstServiceContractor where sc_username='" + Membership.GetUser().UserName.ToString() + "') and DSA.active_flag='True') as tbl group by sap_desc");
                ...
                sbdefcompR.Append(" and DSA.asc_id=(select sc_sno from CIC_IS.dbo.MstServiceContractor where sc_username='" + Membership.GetUser().UserName.ToString() + "') and quantity >0 AND DSA.active_flag='True') as tbl group by sap_desc");
                ...
                sbdefcompD.Append(" and DSA.asc_id=(select sc_sno from CIC_IS.dbo.MstServiceContractor where sc_username='" + Membership.GetUser().UserName.ToString() + "') and quantity>0 AND  DSA.active_flag='True') as tbl group by sap_desc");
                ...
                sbdefstockmov.Append(" and DSA.asc_id=(select sc_sno from CIC_IS.dbo.MstServiceContractor where sc_username='" + Membership.GetUser().UserName.ToString() + "') and quantity>0 AND  DSA.active_flag='True') as tbl group by sap_desc");
                ...
                sbshrt.Append(" INNER JOIN CIC_IS.dbo.MstUnit MU ON MU.UNIT_SNO=SL.PRODUCTDIVISION_ID");
                sbshrt.Append(" INNER JOIN MSTBASICSPARE BS ON BS.SPARE_ID=SL.SPARE_ID where SL.ASC_ID=(select sc_sno from CIC_IS.dbo.MstServiceContractor where sc_username='" + Membership.GetUser().UserName.ToString() + "' )and AL.loc_code='SHRT' and SL.qty > 0 and   SL.productdivision_id=" + ddlproddiv.SelectedValue);
                ...
                foreach (GridViewRow item in gvEng.Rows)
                {
                    ...
                    sbeng1.Append(" INNER JOIN CIC_IS.dbo.MstUnit MU ON MU.UNIT_SNO=SL.PRODUCTDIVISION_ID");
