...
public partial class SIMS_Pages_90DaysRepetitiveComplainReport : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this, typeof(Page), "Alert", "<script>alert('Date range should be within one month');</script>", false);
            return;
        }
    ...
    private Boolean DateRangeCheck()
    {
        ...
        if ((Todate.Year - Fdate.Year == 0) && (Todate.Month - Fdate.Month == 0)) { }
        else
        {
