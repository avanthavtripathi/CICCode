<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master"
    CodeFile="SIMSBranchMaster.aspx.cs" Inherits="SIMS_Pages_SIMSBranchMaster" %>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <asp:DropDownList ID="ddlSearch" runat="server" Width="150px" CssClass="simpletxt1">
                                        ...
                                        <asp:ListItem Text="Branch Address" Value="Branch_Address"></asp:ListItem>
                                        <asp:ListItem Text="Branch Plant Code" Value="Branch_Plant_Code"></asp:ListItem>
                                        <asp:ListItem Text="Branch Plant Desc" Value="Branch_Plant_Desc"></asp:ListItem>
                                ...
                                <td class="bgcolorcomm">
                                    <asp:GridView ID="gvComm" runat="server" AllowPaging="True" AllowSorting="True" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Branch_Plant_Code" SortExpression="Branch_Plant_Code"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Branch Plant Code" ItemStyle-HorizontalAlign="Left">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Branch_Plant_Desc" SortExpression="Branch_Plant_Code_Desc"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Branch Plant Desc" ItemStyle-HorizontalAlign="Left">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                ...
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtBranchCode" runat="server" MaxLength="20"
                                                    Width="170px" Text="" />&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                                        runat="server" SetFocusOnError="true" ErrorMessage="Branch Code is required."
                                                        ControlToValidate="txtBranchCode" ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtBranchName" MaxLength="100" runat="server"
                                                    Width="170px" Text="" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtBranchAddress" MaxLength="150" runat="server"
                                                    Width="170px" Text="" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" SetFocusOnError="true"
                                                    ErrorMessage="Branch Address is required." ControlToValidate="txtBranchAddress"
                                                    ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                Branch Plant Code<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtBranchPlantCode" runat="server" Width="170px"
                                                    Text="" MaxLength="4" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" SetFocusOnError="true"
                                                    ErrorMessage="Branch Plant Code is required." ControlToValidate="txtBranchPlantCode"
                                                    ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                Branch Plant Desc<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtBranchPlantDesc" runat="server" Width="170px"
                                                    Text="" MaxLength="50" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" SetFocusOnError="true"
                                                    ErrorMessage="Branch Plant Description is required." ControlToValidate="txtBranchPlantDesc"
                                                    ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
