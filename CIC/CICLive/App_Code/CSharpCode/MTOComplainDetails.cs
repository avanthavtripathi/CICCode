...
public class MTOComplainDetails
{
    ...
    public void SaveData()
    {
        ...
        SqlParameter[] sqlParamI =
        {
          ...
          //change by sujit on 11-05-2010
          new SqlParameter("@DateOfReporting",this.Date_of_Reporting),

          // bhawesh for RSD
           new SqlParameter("@EquipmentName",this.EQUIPMENT_NAME),
           new SqlParameter("@CoachNo",this.COACH_NO),
           new SqlParameter("@TrainNo",this.TRAIN_NO),
           new SqlParameter("@AvailabilityDepot",this.AVAILABILITY_DEPOT)
        };
    ...
    // Added by bhawesh : 1 march 12 , for Railway Signaling
    ...
    { get; set; }
    public string AVAILABILITY_DEPOT
    { get; set; }
    // END -------------------------------------------
    ...
    public void InsertDefect()
    {
        SqlParameter[] sqlParamI =
        {
           ...
           // bhawesh added 22 march 12 RSD Change
           new SqlParameter("@COACH_NO",this.COACH_NO),
           new SqlParameter("@TRAIN_NO",this.TRAIN_NO),
           new SqlParameter("@AVAILABILITY_DEPOT",this.AVAILABILITY_DEPOT),
           new SqlParameter("@EQUIPMENT_NAME",this.EQUIPMENT_NAME)
    ...
    public void UpdateAttributes()
    {
        SqlParameter[] sqlParamI =
        {
           ...
           // bhawesh added mto 22 m 12 ESD Change
            new SqlParameter("@COACH_NO",this.COACH_NO),
            new SqlParameter("@TRAIN_NO",this.TRAIN_NO),
            new SqlParameter("@AVAILABILITY_DEPOT",this.AVAILABILITY_DEPOT),
            new SqlParameter("@EQUIPMENT_NAME",this.EQUIPMENT_NAME),
    ...
    public DataSet GetAttrbuteDataFromPPR_MTO()
    {
        SqlParameter[] param ={
                                  new SqlParameter("@Type","GETATTRIBUTEDATAFROMPPR_MTO"),
                                  new SqlParameter("@Complaint_RefNo",this.Complaint_RefNo),
                                  new SqlParameter("@SplitComplaint_RefNo",this.SplitComplaint_RefNo),
                              };
        DataSet ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspBaseComDet_MTO", param);
