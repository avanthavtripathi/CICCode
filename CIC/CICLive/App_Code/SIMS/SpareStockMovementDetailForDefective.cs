...
/// </summary>
public class SpareStockMovementDetailForDefective
{
    SIMSSqlDataAccessLayer objSqlDataAccessLayer = new SIMSSqlDataAccessLayer();
    SIMSCommonClass objCommonClass = new SIMSCommonClass();
    DataSet dstData;
    public SpareStockMovementDetailForDefective()
    { }
    ...
    public DataSet BindData(GridView grv)
    {
        ...
        dstData = objCommonClass.BindDataGrid(grv, "uspRPTDefectiveStock", true, sqlParamSrh, true);
        return dstData;
    }
