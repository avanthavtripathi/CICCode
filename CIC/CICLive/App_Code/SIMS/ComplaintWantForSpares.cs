...
public class ComplaintWantForSpares
{
    ...
    public void BindRegionData(DropDownList ddl)
    {
        ...
        DataSet ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspRPTComplaintPendingForSpare", param);
        ddl.DataSource = ds;
