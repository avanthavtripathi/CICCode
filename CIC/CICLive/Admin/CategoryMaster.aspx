<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="CategoryMaster.aspx.cs" Inherits="Admin_ProductLineMaster" %>
                                ...
                                <td align="left" class="MsgTDCount">
                                    ...
                                    <td align="right">
                                        ...
                                        <asp:DropDownList ID="ddlSearch" runat="server" CssClass="simpletxt1" Width="130px">
                                            ...
                                            <asp:ListItem Text="Description" Value="Category_Name"></asp:ListItem>
                                    ...
                                    <td>
                                        ...
                                        <asp:GridView ID="gvComm" runat="server" AllowPaging="True" AllowSorting="True" AlternatingRowStyle-CssClass="fieldName"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Category_Name"  SortExpression="Category_Name" HeaderStyle-HorizontalAlign="Left" HeaderText="Description"
                                                    ItemStyle-HorizontalAlign="Left">
                                                    <HeaderStyle HorizontalAlign="Left" />
                                                    <ItemStyle HorizontalAlign="Left" />
                                                 </asp:BoundField>
                                ...
                                <tr>
                                    <td align="left" class="bgcolorcomm" width="100%">
                                        <table border="0" width="98%">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:HiddenField ID="hdnCategorySNo" runat="server" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtCategoryDesc" runat="server" CssClass="txtboxtxt" Text=""
                                                        MaxLength="100" Width="170px" />
                                                    &nbsp;<asp:RequiredFieldValidator ID="RFVPLD" runat="server" ControlToValidate="txtCategoryDesc"
                                                        ErrorMessage="Category Description is required." SetFocusOnError="true" ValidationGroup="editt"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
