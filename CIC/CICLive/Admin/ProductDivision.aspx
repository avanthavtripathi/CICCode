<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="ProductDivision.aspx.cs" Inherits="Admin_UnitMaster" %>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        HeaderStyle-CssClass="fieldNamewithbgcolor" GrindGroup="Both" AllowPaging="True"
                            ...
                            <tr>
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            <td width="30%">
                                                Warranty From Manufacturing<br />
                                                (in month)
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtWarrFManuf" runat="server" Width="170px"
                                                    Text="" MaxLength="100" />
                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"
                                                        SetFocusOnError="true" ErrorMessage=" Warranty From Manufacturing is required." ControlToValidate="txtWarrFManuf"
                                                        ValidationGroup="editt"></asp:RequiredFieldValidator>--%>
                                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtWarrFManuf"
                                                    ErrorMessage="Enter whole numbers only." Operator="DataTypeCheck" Type="Integer"
                                                    SetFocusOnError="True" ValidationGroup="editt"></asp:CompareValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                                Warranty From Purchase<br />
                                                (in month)
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtWarrFPurchase" runat="server" Width="170px"
                                                    Text="" MaxLength="100" />
                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server"
                                                        SetFocusOnError="true" ErrorMessage=" Warranty From Purchase is required." ControlToValidate="txtWarrFPurchase"
                                                        ValidationGroup="editt"></asp:RequiredFieldValidator>--%>
                                                <asp:CompareValidator ID="CC1" runat="server" ControlToValidate="txtWarrFPurchase"
                                                    ErrorMessage="Enter whole numbers only." Operator="DataTypeCheck" Type="Integer"
                                                    SetFocusOnError="True" ValidationGroup="editt"></asp:CompareValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtVistCharge" runat="server" Width="170px"
                                                    Text="" MaxLength="100" />
