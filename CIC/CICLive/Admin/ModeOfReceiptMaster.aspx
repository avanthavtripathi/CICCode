<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="ModeOfReceiptMaster.aspx.cs" Inherits="Admin_ModeOfReceiptMaster" %>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <asp:DropDownList ID="ddlSearch" runat="server" Width="130px" CssClass="simpletxt1">
                                        <asp:ListItem Text="Code" Value="ModeOfReceipt_Code"></asp:ListItem>
                                        <asp:ListItem Text="Description" Value="ModeOfReceipt_Desc"></asp:ListItem>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        AllowSorting="True" DataKeyNames="ModeOfReceipt_sno" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ModeOfReceipt_Code" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Code" SortExpression="ModeOfReceipt_Code">
                                                <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ModeOfReceipt_Desc" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Description" SortExpression="ModeOfReceipt_Desc">
                            ...
                            <tr>
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:HiddenField ID="hdnModeOfReceiptSNo" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                                Mode Of Receipt Code<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtModeOfReceiptCode" runat="server" Width="170px"
                                                    Text="" MaxLength="10" /><asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                                        runat="server" SetFocusOnError="true" ErrorMessage="Mode Of Receipt Code is required."
                                                        ControlToValidate="txtModeOfReceiptCode" ValidationGroup="editt" ToolTip="Mode Of Receipt Code is required."></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                                Mode Of Receipt Description<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtModeOfReceiptDesc" runat="server" Width="170px"
                                                    Text="" />&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                        SetFocusOnError="true" ErrorMessage="Mode Of Receipt Description is required."
                                                        ControlToValidate="txtModeOfReceiptDesc" ToolTip="Mode Of Receipt Description is required."
