<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="CountryMaster.aspx.cs" Inherits="Admin_CountryMaster" %>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <asp:DropDownList ID="ddlSearch" runat="server" Width="130px" CssClass="simpletxt1">
                                        <asp:ListItem Text="Code" Value="Country_Code"></asp:ListItem>
                                        <asp:ListItem Text="Description" Value="Country_Desc"></asp:ListItem>
                                    </asp:DropDownList>
                                    With
                            ...
                            <tr>
                                <td class="bgcolorcomm">
                                    ...
                                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        PagerStyle-HorizontalAlign="Center" AllowSorting="True" DataKeyNames="country_sno"
                                        ...
                                        OnRowDataBound="gvComm_RowDataBound" EnableSortingAndPagingCallbacks="True" OnSorting="gvComm_Sorting">
                                        <Columns>
                                            <asp:BoundField DataField="Sno" HeaderStyle-Width="40px" HeaderText="SNo" ItemStyle-HorizontalAlign="Center">
                                                <HeaderStyle Width="40px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Country_Code" SortExpression="Country_Code" HeaderStyle-Width="60px"
                            ...
                            <tr>
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:HiddenField ID="hdnCountrySNo" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtCountryCode" runat="server" Width="170px"
                                                    Text="" /><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                        SetFocusOnError="true" ErrorMessage="Country Code is required." ControlToValidate="txtCountryCode"
                                                        ValidationGroup="editt" ToolTip="Country Code is required."></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                                Country Description<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtCountryDesc" runat="server" Width="170px"
                                                    Text="" /><asp:RequiredFieldValidator ID="reqvalDeptIname" runat="server" SetFocusOnError="true"
                                                        ErrorMessage="Country Description is required." ToolTip="Country Description is required."
                                                        ControlToValidate="txtCountryDesc" ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
