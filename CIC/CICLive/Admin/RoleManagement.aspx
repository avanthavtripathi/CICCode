                        ...
                        <table border="0" width="100%"><tr>
                                ...
                                <td align="right">
                                    ...
                                    <asp:DropDownList ID="ddlSearch" runat="server" Width="130px" CssClass="simpletxt1">
                                        <asp:ListItem Text="Name" Value="RoleName"></asp:ListItem>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        AllowSorting="True" DataKeyNames="RoleId" AutoGenerateColumns="False" ID="gvComm"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="RoleName" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Name" SortExpression="RoleName">
                                                <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Description" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                            ...
                            <tr>
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:HiddenField ID="hdnRoleId" runat="server" /> <asp:HiddenField ID="hdnEditType" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtRoleName" runat="server" Width="170px" Text="" />
                                                <asp:RequiredFieldValidator
                                                    ID="RequiredFieldValidator2" runat="server" SetFocusOnError="true" ErrorMessage="Role Name is required."
                                                    ControlToValidate="txtRoleName" ValidationGroup="editt" ToolTip="Role Name is required."></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtRoleDesc" runat="server" Width="170px" Text="" />
                                                <asp:RequiredFieldValidator ID="reqvalDeptIname" runat="server" SetFocusOnError="true"
                                                    ToolTip="Description is required." ErrorMessage="Description is required." ControlToValidate="txtRoleDesc"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <%--<asp:RequiredFieldValidator SetFocusOnError="true" ID="RequiredFieldValidator3" runat="server"
                                                    ControlToValidate="ddlUserType" ErrorMessage="User Type is required." ValidationGroup="editt"
                                                    ToolTip="User Type is required." InitialValue="0"></asp:RequiredFieldValidator>--%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
