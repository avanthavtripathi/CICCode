<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true" CodeFile="MstVendorSymbol.aspx.cs" Inherits="Admin_MstCapacitorMaster" Title="Blade Vendor Master" %>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        AllowSorting="True" DataKeyNames="Ident_Sno" AutoGenerateColumns="False" ID="gvComm"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Unit_Desc" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                             ...
                                             <asp:BoundField DataField="BladeVendor" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="BladeVendor Name" SortExpression="BladeVendor">
                                            </asp:BoundField>
                                             <asp:BoundField DataField="Identification" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Identification" SortExpression="Identification">
                                    ...
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddldefect" runat="server" CssClass="simpletxt1" ValidationGroup="editt">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddldefect"
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCapacitor" runat="server" CssClass="simpletxt1" ValidationGroup="editt">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtCapacitor"
                                                    ErrorMessage="Vendor Name is required."  SetFocusOnError="true"
                                                    ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td width="30%">
                                                Symbol <font color="red">*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtSymbol" runat="server" CssClass="simpletxt1" ValidationGroup="editt">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtCapacitor"
                                                    ErrorMessage="Vendor Symbol is required."  SetFocusOnError="true"
                                                    ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="30%">
                                                Unit</td>
                                            <td>
                                                <asp:TextBox ID="txtUnit" runat="server" Text="" CssClass="simpletxt1"></asp:TextBox>
                                                </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
