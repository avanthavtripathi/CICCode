                ...
                <td class="bgcolorcomm" colspan="2">
                    <table width="99%">
                        <tr style="margin-top: 5px;">
                            <td class="headingred" align="center" style="font-size: 15px">Customer Feedback Registration</td>
                        </tr>
                        <tr>
                            <td>
                                                ...
                                                <td colspan="2">
                                                    <table width="100%" border="0" cellpadding="1" cellspacing="0" class="bgcolorcomm">
                                                        ...
                                                        <tr style="font-weight: bold; font-size: 14px; line-height: 40px; background-color: #dddddd">
                                                            <td align="left" style="padding-left: 10px">Service Request Type<font color="red">*</font></td>
                                                            <td colspan="2">
                                                        ...
                                                        <tr id="trlogin" style="background-color: #dddddd" runat="server" visible="false">
                                                            <td colspan="3" style="padding: 5px">UserName :
                                                                <asp:TextBox ID="TxtSCName" runat="server" CssClass="txtboxtxt" Width="150px"
                                                                    MaxLength="30"></asp:TextBox>
                                                                &nbsp; Password :
                                                                <asp:TextBox ID="TxtPwd" runat="server" CssClass="txtboxtxt" Width="150px"
                                                        ...
                                                        <tr>
                                                            <td colspan="2">&nbsp;</td>
                                                            <td align='<%=ConfigurationManager.AppSettings["MandatoryTextAlign"]%>'>&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">
                                                                <asp:Panel ID="tblenable" runat="server">
                                                                    <table width="100%" border="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>Address 1<font color='red'>*</font>
                                                                            </td>
                                                                            <td colspan="3">
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                    ...
                                                                                    <ContentTemplate>
                                                                                        ...
                                                                                        <table id="tblcomplaint" runat="server" width="100%" border="0" cellpadding="2" cellspacing="0">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>Product Division<font color='red'>*</font>
                                                                                                </td>
                                                                                                <td colspan="3">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>Quantity<font color='red'>*</font>
                                                                                                </td>
                                                                                                <td colspan="3">
