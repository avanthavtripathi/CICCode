...
public partial class pages_PrintCallSlipIS : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (strBid != "0" || xmlDoc!=null)
            {
                ...
                for (int i = 0; i < dsuser.Tables[0].Rows.Count; i++)
                {
                    ...
                    "src='../images/Crompton-greaves.jpg'></td></tr><tr><td height='22'>&nbsp;<asp:HiddenField ID='hdnSplitNo' runat='server' />" +
                    ...
                    "<td colspan='4' align='center' class='TableHead' style='font-size:12px'>Authorized Crompton Greaves Service Center</td>" +
                    ...
                    "Type Of Complaint:</td></tr><tr><td colspan='4'><span " +
            ...
            else
            {
                ...
                strBody = strBody.Append("<tr><td><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='25%'" +
                    ...
                    "src='../images/Crompton-greaves.jpg'></td></tr><tr><td height='22'>&nbsp;<asp:HiddenField ID='hdnSplitNo' runat='server' />" +
                    "</td></tr><tr><td class='boldTxt'>For Product Service Needs</td></tr><tr><td>" +
                    "Call Toll Free - <font class='boldTxt'>1-800-267-0505</font></td></tr></table><!--//Column Name--></td>" +
                    "<td width='50%' class='TdRightBorder'><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr>" +
                    "<td colspan='4' align='center' class='TableHead' style='font-size:12px'>Authorized Crompton Greaves Service Center</td>" +
                    "</tr><tr><td width='17%'>&nbsp;</td><td width='36%'>&nbsp;<asp:HiddenField ID='hdnComNo' runat='server' /></td>" +
                    "<td width='15%'>&nbsp;</td><td width='32%'>&nbsp;</td></tr><tr><td colspan='4'>Managed By <span>" +
    ...
    private void MeargeHTMLBody(string natureOfComplaint)
    {
        strBody = strBody.Append("<table width='750' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td class='Tdleft'>" +
                    ...
                    "</td></tr><tr><td width='50%' valign='top'><table width='99%' border='0' cellspacing='0' cellpadding='1' class='table' height='70'>" +
                    ...
                    "<tr><td width='33%' height='22' align='center' class='TableHead'>&nbsp;</td>" +
                    ...
                    "<table width='96%' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr>" +
                    "<tr><td align='center' style='border-top: 1px solid #000000'>Customer's Signature &amp; Date</td></tr>" +
                    "<tr><td>&nbsp;</td></tr><tr><td>I hereby acknowledge that I am satisfied with the repair of my equipment</td>" +
                    ...
                    "Registered Office: CG House, 6th Floor, Dr. Annie Besant Road. Worli,Mumbai - 400 030, INDIA W:www.cgglobal.com.</font></td>" +
