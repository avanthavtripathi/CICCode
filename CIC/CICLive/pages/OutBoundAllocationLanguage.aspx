<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true" CodeFile="OutBoundAllocationLanguage.aspx.cs" Inherits="pages_OutBoundAllocationLanguage" Title="Untitled Page" %>
    ...
    <asp:UpdatePanel ID="pnl" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table width="1000" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="headingred">
                       Language Barrier Call Allocation
                    </td>
                                      ...
                                      <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                               <tr>
                                                <td width="25%" style="padding-left:10px" valign="top">
                                                 <b>    Total Unallocated Complaint (59)</b>
                                                </td>
                                                <td>
                                                    ...
                                                    <div style="text-align:right;padding-right:50px">
                                                           <asp:Button ID="btnAllocate" runat="server" CssClass="btn" Enabled="false"  
                                ...
                                <tr>
                                    <td>
                                       <asp:RadioButtonList ID="rbtnlst" runat="server" AutoPostBack="true" 
                                            DataValueField="LanguageID" DataTextField="DisplayText" 
                                            onselectedindexchanged="rbtnlst_SelectedIndexChanged" />
