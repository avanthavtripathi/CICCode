<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="MTOServiceRegistration1.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="pages_MTOServiceRegistration1" %>
                    ...
                    <td class="tableBGcolor" colspan="2">
                        <table border="0" cellpadding="2" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td align="right">
                                    <a href="MTOServiceRegistration1.aspx">Clear Search</a>
                                </td>
                            </tr>
                                            ...
                                            <ContentTemplate>
                                                <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            ...
                                                            <asp:Button ID="btnGoPL" runat="server" Width="20px" Text="Go" CssClass="btn" CausesValidation="false"
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            Logged Date<font color='red'>*</font>
                                                        </td>
                                                        <td colspan="3">
                                                            <asp:TextBox ID="txtComplaintLoggedDate" MaxLength="10" runat="server" CssClass="txtboxtxt" Width="100px"></asp:TextBox>
                                                            &nbsp;(mm/dd/yyyy)
                                                            <asp:RequiredFieldValidator SetFocusOnError="true" ID="RequiredFieldValidator6" runat="server"
                                                                Display="None" ControlToValidate="txtComplaintLoggedDate" ErrorMessage="Complaint Logged Date is required."></asp:RequiredFieldValidator>
                                                            <asp:CompareValidator ID="CompareValidator15" runat="server" Type="Date" Operator="DataTypeCheck"
                                                                ControlToValidate="txtComplaintLoggedDate" Display="None" ErrorMessage="Valid Complaint Logged date is required. "></asp:CompareValidator>
                                                        ...
                                                        <td colspan="4">
                                                            <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox MaxLength="10" runat="server" ID="txtxPurchaseDate" OnTextChanged="txtxPurchaseDate_TextChanged"
                                                                            AutoPostBack="true" CssClass="txtboxtxt" />&nbsp;(mm/dd/yyyy)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox MaxLength="10" runat="server" ID="txtCommissionDate" CssClass="txtboxtxt"
                                                                ...
                                                                Display="None"></asp:CompareValidator>--%>
                                                                    ...
                                                                    <td id="tdAllocate" runat="server" visible="false">
                                                                        ...
                                                                        <asp:CompareValidator SetFocusOnError="true" ID="CompareValidator11" runat="server"
                                                                            ...
                                                                            ValueToCompare="0" Display="None"></asp:CompareValidator>
                                                                        <asp:DropDownList ID="ddlCGExec" runat="server" CssClass="simpletxt1" Width="175px">
                                                                        </asp:DropDownList>
                                                ...
                                                <td colspan="3" align="left">
                                                    <asp:TextBox ID="txtSc" CssClass="txtboxtxt" Width="250px" Enabled="false" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                                                        ...
                                                        <tr>
                                                            <td colspan="4" align="center">
                                                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn" Text="Save" Width="70px"
                                                                ...
                                                                <asp:Button ID="btnCancel" runat="server" CausesValidation="false" CssClass="btn"
                                                                    Text="Cancel" OnClick="btnCancel_Click" OnClientClick="return funConfirm();" />
                                                                &nbsp;
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                                                                ...
                                                                                <td>
                                                                                    <asp:GridView PageSize="15" DataKeyNames="Sno" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                                                HeaderText="CG Executive">
                                                                                                <ItemTemplate>
                                                                                                    <%#Eval("CGExecuative")%></a>
                                                                                                </ItemTemplate>
                                                                                            </asp:TemplateField>
                                                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                                                                                HeaderText="CG Contract Employee">
                                                                                                <ItemTemplate>
                                                                            ...
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <a href="MTOComplainDetails1.aspx">MTO Complaint Detail screen</a>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="center">
