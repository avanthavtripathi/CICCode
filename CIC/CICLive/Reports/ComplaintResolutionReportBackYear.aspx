<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true" CodeFile="ComplaintResolutionReportBackYear.aspx.cs" Inherits="Reports_ComplaintResolutionReportBackYear" EnableEventValidation="false" %>
 ...
 <tr>
        ...
        <td align="left">
            <br /> <asp:Button ID="btnSearch" runat="server" CausesValidation="true" 
                ...
                Width="70px" />
            <asp:Button ID="btnExport" runat="server" CssClass="btn" Text="Export" 
                Visible="false" Width="70px" onclick="btnExport_Click" />
        </td>
    </tr>  
    <tr>
    <td colspan="2">
