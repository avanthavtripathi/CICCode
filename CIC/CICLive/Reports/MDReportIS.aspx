<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true" CodeFile="MDReportIS.aspx.cs" Inherits="Reports_MDReport" Title="MD Report" %>
                        ...
                        <table width="98%" border="0">
                            ...
                            <tr style="display:none;">
                              ...
                              <asp:DropDownList ID="ddlPg" runat="server" Width="175px" CssClass="simpletxt1" >
                                        <asp:ListItem Value="15,19" Text="IS" Selected="True"></asp:ListItem>
                              </asp:DropDownList>
