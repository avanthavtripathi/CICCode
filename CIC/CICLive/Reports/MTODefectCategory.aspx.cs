...
public partial class Reports_MTODefectCategory : System.Web.UI.Page
{
    ...
    SqlParameter[] sqlParamSrh =
        {
            new SqlParameter("@Type","DEFECT_CATEGORY"),
    ...
    {
        //Reports/MTODefectCategory.aspx
        if (!Page.IsPostBack)
        {
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        dsReport = objMTOReport.ReportData("DEFECT_CATEGORY");
        rvMisDeatil.LocalReport.ReportPath = "Reports\\BarReport\\DefectCategory.rdlc";
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=MTODefectCategory.xls");
