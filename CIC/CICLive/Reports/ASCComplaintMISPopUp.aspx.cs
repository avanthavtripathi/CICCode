...
public partial class Reports_ASCComplaintMISPopUp : System.Web.UI.Page
{
    DataSet ds;
    ...
    SqlParameter[] param ={
                             ...
                             //Add By Binay-26-11-2009
                             new SqlParameter("@BusinessLine_Sno",0),
                             new SqlParameter("@ddlResolver",0), //ResolverType
                             new SqlParameter("@ddlCGExec",""), // CG User
                             new SqlParameter("@ddlCGContractEmp","")  // CG Contract Emp
                             //End 
                          };
    ...
    protected void BindGrid(string strOrder)
    {
        ...
        //Add Code By Binay-26-11-2009 For MTS & MTO
        param[10].Value = Convert.ToInt16(Request.QueryString["BusinessLine_Sno"].ToString()); // Businessline_Sno for MTS & MTO
        if (param[10].Value.ToString() == "2")
        {
            param[5].Value = Convert.ToInt16(Request.QueryString["Sc_Sno"].ToString());
        ...
        ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "ASCComplaintMISPopUp", param);
    ...
    private void SearchData()
    {
        try
        {
            ...
            if (gvMIS.PageIndex != -1)
                gvMIS.PageIndex = 0;
            //Add Code By Binay For MTS and MTO (26-11-2009)
            if (param[10].Value.ToString() == "2")
            {
                param[1].Value = Request.QueryString["Type"].ToString();
                string strType = param[1].Value.ToString();
    ...
    //Add Code By Binay For MTO(29-11-2009)
