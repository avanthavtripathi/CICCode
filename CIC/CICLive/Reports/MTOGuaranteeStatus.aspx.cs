...
public partial class Reports_MTOGuaranteeStatus : System.Web.UI.Page
{
    ...
    //    {
    //        new SqlParameter("@Type","SELECT_WARRANTYSTATUS"),
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        dsReport = objMTOReport.ReportData("WARRANTYSTATUS");
        rvMisDeatil.LocalReport.ReportPath = "Reports\\BarReport\\GuaranteeStatus.rdlc";
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=MTOGuaranteeStatus.xls");
