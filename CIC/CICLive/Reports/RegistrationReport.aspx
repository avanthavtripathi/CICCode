<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true" EnableEventValidation="false" 
    CodeFile="RegistrationReport.aspx.cs" Inherits="Reports_ServiceRegistrationReport" %>
                ...
                <tr>
                    <td style="padding: 10px" align="center" colspan="2">
                        <table width="98%" border="0">
                            ...
                            <tr>
                                <td width="30%" align="right">Complaint Stage</td>
                                <td align="left">
                                    <asp:DropDownList ID="ddlCallStage" runat="server" CssClass="simpletxt1" Width="175px"
                                     AutoPostBack="true" OnSelectedIndexChanged="ddlCallStage_SelectedIndexChanged"  ValidationGroup="editt">
                             ...
                             <tr>
                                <td width="30%" align="right">Complaint Status</td>
                                <td align="left">
                                    <asp:DropDownList ID="ddlCallStatus" runat="server" CssClass="simpletxt1" Width="350px" ValidationGroup="editt">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    To 
                                    <asp:TextBox runat="server" ID="txtToDate" CssClass="txtboxtxt" ValidationGroup="editt" MaxLength="10" />
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlDefectCategory" runat="server" Width="300px" CssClass="simpletxt1"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddlDefectCategory_SelectedIndexChanged"  ValidationGroup="editt">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlDefect" runat="server" Width="350px" CssClass="simpletxt1" ValidationGroup="editt">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                            <td align="right">SRF</td>
                            <td align="left">
                            ...
                            <asp:ListItem Value="Y">Yes</asp:ListItem>
                             ...
                             <tr>
                            <td align="right">Warranty Status</td>
                            <td align="left">
                            ...
                            <tr>
                                ...
                                <td align="left"><br />
                                    ...
                                    <asp:Button Width="100px" Text="Export To Excel" CssClass="btn"  
                            ...
                            <tr>
                             ...
                             <td align="left" class="MsgTDCount">
                               Total Number of Complaints : <asp:Label ID="lblRowCount" CssClass="MsgTotalCount" runat="server"></asp:Label>
                                </td>
                                <td>
                              ...
                              <tr>
                               ...
                               <td align="left" class="MsgTDCount">
                                Total Number of Defects : <asp:Label ID="lblDefectCount" CssClass="MsgTotalCount" runat="server"></asp:Label>
                               </td>
                               <td></td>
                            </tr>
                        </table>
                        ...
                        <table width="100%" border="0">
                            <tr>
                                <td>
                                    <!-- Action Listing -->
                                    <asp:GridView PageSize="10" GridGroups="both" AllowPaging="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UniqueContact_No" HeaderText="ContactNo" />
                                             ...
                                             <asp:BoundField DataField="LoggedDate" SortExpression="LoggedDate" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Log Date">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="SLA_Date" SortExpression="SLA_Date" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="SLA Date">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="ProductDivision_Desc" SortExpression="ProductDivision_Desc" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <asp:BoundField DataField="SRF" SortExpression="SRF" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                            HeaderText="SRF">
                                            <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="WarrantyStatus" SortExpression="WarrantyStatus" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                            ...
                                            <asp:BoundField DataField="NatureOfComplaint" SortExpression="NatureOfComplaint" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                ...
                                                <asp:BoundField DataField="ComplaintAgeSLA" SortExpression="ComplaintAgeSLA" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Age On SLA date">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ComplaintAgeLOG" SortExpression="ComplaintAgeLOG" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Age On Log date">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                        </Columns>
                            ...
                            <tr>
                                <td>
                                  <asp:GridView GridGroups="both" AutoGenerateColumns="False"
                                        ID="GVExport" runat="server" Width="100%" HorizontalAlign="Left" Visible="false" >
                                        <Columns>
                                            <asp:BoundField DataField="RowNumber" HeaderStyle-Width="40px" HeaderText="SNo">
                                                <HeaderStyle Width="40px" />
                                            </asp:BoundField>
