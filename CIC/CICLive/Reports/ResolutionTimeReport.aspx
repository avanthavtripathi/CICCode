...
CodeFile="ResolutionTimeReport.aspx.cs" Inherits="Reports_ResolutionTimeReport" Title="Resolution Time Report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainConHolder" runat="Server">
    <table width="100%" border="0">
        <tr>
            <td class="headingred">
                MIS-BRM Resolution Time Report 0-2 days for CP & 0-3 for Motors</td>
