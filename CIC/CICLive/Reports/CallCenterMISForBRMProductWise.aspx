...
CodeFile="CallCenterMISForBRMProductWise.aspx.cs" Inherits="Reports_CallCenterMISForBRMProductWise" 
Title="Average % wise closed Complaints" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainConHolder" runat="Server">
    <table width="100%" border="0">
        <tr>
            <td class="headingred">
                MIS-BRM Average % wise closed Complaints</td>
