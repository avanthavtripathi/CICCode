...
public partial class Reports_MTODefectProduct : System.Web.UI.Page
{
    ...
    SqlParameter[] sqlParamSrh =
        {
            new SqlParameter("@Type","SELECT_DEFECT_PRODUCT"),
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        dsReport = objMTOReport.ReportData("DEFECTWISE_PRODUCTWISE");
        rvMisDeatil.LocalReport.ReportPath = "Reports\\BarReport\\DefectAndProductWise.rdlC";
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=MTODefectProduct.xls");
