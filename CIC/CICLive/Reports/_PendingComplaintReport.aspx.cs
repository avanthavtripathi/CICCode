    ...
    private void BindGrid(int currentPage)
    {
        try
        {
            ...
            if ((txtFromDate.Text != "") && (txtToDate.Text != ""))
            {
                ...
                // for custom paging 
                int startRowNumber = ((currentPage - 1) * pageSize) + 0;
                ...
                if (ddlBusinessLine.SelectedValue == "2")
                {
                    objMisReport.BindDataGrid(gvComm, "uspMisDetail_MTS", true, sqlParamSrh, lblRowCount, lblDefectCount);//uspMisDetail_MTS_TESt1
                }
                else
                {
