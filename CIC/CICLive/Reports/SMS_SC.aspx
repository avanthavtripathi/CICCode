<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true" CodeFile="SMS_SC.aspx.cs" Inherits="Reports_SMS_SC" Title="SMS Status Update Report" EnableEventValidation="false"  %>
                 ...
                 <td colspan="2">
                   <br /><b>Summary</b><br />
                        ...
                        <asp:GridView ID="GvSummary" CssClass="simpletxt1" runat="server" RowStyle-CssClass="bgcolorcomm"
                            Width="50%" AlternatingRowStyle-CssClass="fieldName" HeaderStyle-CssClass="fieldNamewithbgcolor"
                            GridGroups="both" HorizontalAlign="Left" AutoGenerateColumns="false" >
                            <RowStyle CssClass="bgcolorcomm" />
                            <Columns>
                                <asp:TemplateField HeaderText="SNo">
