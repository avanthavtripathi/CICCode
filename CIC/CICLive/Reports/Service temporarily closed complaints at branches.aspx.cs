...
public partial class Reports_Service_temporarily_closed_complaints_at_branches : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void BindGrid(string strOrder)
    {
        ...
        ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspMIS4SCREEN", param);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=Service_temporarily_closed_complaints_at_branches.xls");
