...
public partial class Reports_BranchWiseDivisionWisePendency : System.Web.UI.Page
{
    /// <summary>
    ...
    protected void BindGrid(string strOrder)
    {
        ...
        param[6].Value = int.Parse(ddlBusinessLine.SelectedValue.ToString());     
        ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspMIS1SCREEN", param);
