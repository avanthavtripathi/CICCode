...
public partial class UC_UC_DealerForm : System.Web.UI.UserControl
{
        ...
        try
        {
            ...
            if (!blnFlag)
            {
                ...
                if (dsTemp.Tables[0].Rows.Count > 0)
                {
                    ...
                    objCallRegistration.Customer_Type = "L";
    ...
    private void CreateRow()
    {
        ...
        if (!blnFlag) 
        {
            ...
            dRow["ModeOfReceipt_SNo"] = "8"; // ModeOfReceipt_SNo
            ...
            dRowDisp["ModeOfReceipt"] = "DLRForm(007)";//ddlModeOfRec.SelectedItem.Text.ToString();
    ...
    private void UpdateRowSource(int intKey)
    {
        ...
        if (!blnFlag)    // If record is not already exist for correspodning product division then save it
        {
            ...
            dsTemp.Tables[0].Rows[intKey]["ModeOfReceipt_SNo"] = "8"; //ddlModeOfRec.SelectedValue.ToString();
            ...
            dsTemp.Tables[1].Rows[intKey]["ModeOfReceipt"] = "DLRForm(007)"; //ddlModeOfRec.SelectedItem.Text.ToString();
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("complaintregistrationCP.aspx");
            ClearControls();
            tableResult.Visible = false;
        }
    }
