<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="BatchMaster.aspx.cs" Inherits="Admin_BatchMaster" %>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <asp:DropDownList ID="ddlSearch" runat="server" Width="160px" CssClass="simpletxt1">
                                        <asp:ListItem Text="Batch Description" Value="Batch_Code"></asp:ListItem>
                                    </asp:DropDownList>
                                    With
                        ...
                        <table width="80%" border="0">
                            <tr>
                                <td>                                   
                                    ...
                                    <!-- Batch Listing -->
                                    <asp:GridView PageSize="26" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        HeaderStyle-CssClass="fieldNamewithbgcolor" GridGroups="both" AllowPaging="True"
                                        AllowSorting="True" DataKeyNames="Batch_SNo" AutoGenerateColumns="False" ID="gvComm"
                                        runat="server" OnPageIndexChanging="gvComm_PageIndexChanging" Width="60%" OnSelectedIndexChanging="gvComm_SelectedIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Batch_Code" SortExpression="Batch_Code" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Batch Description">
                            ...
                            <tr>
                                <td width="60%" align="left" class="bgcolorcomm">
                                    <table width="100%" border="0">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:HiddenField ID="hdnBatchSNo" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                                Batch&nbsp; Description<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtBatchCode" runat="server" Width="170px" CssClass="txtboxtxt"
                                                    Text="" MaxLength="1"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="reqvalDeptIname" runat="server" SetFocusOnError="true"
                                                    ErrorMessage="Batch Description is required." ControlToValidate="txtBatchCode"
