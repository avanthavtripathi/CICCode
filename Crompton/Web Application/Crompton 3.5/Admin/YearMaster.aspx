<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="YearMaster.aspx.cs" Inherits="Admin_YearMaster" %>
                    ...
                    <td style="padding: 10px" align="center" colspan="2">
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <asp:DropDownList ID="ddlSearch" runat="server" Width="130px" CssClass="simpletxt1">
                                        <asp:ListItem Text="Code" Value="PERIODYEAR_CODE"></asp:ListItem>
                                        <asp:ListItem Text="Description" Value="PERIODYEAR"></asp:ListItem>
                        ...
                        <table width="100%" border="0">
                            <tr>
                                <td>
                                    <!-- Action Listing -->
                                    <asp:GridView PagerStyle-HorizontalAlign="Left" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        HeaderStyle-CssClass="fieldNamewithbgcolor" GridGroups="both" AllowPaging="True"
                                        AllowSorting="True" DataKeyNames="Year_SNo" AutoGenerateColumns="False" ID="gvComm"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="PERIODYEAR_CODE" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Code" SortExpression="PERIODYEAR_CODE">
                                                <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="PERIODYEAR" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Description" SortExpression="PERIODYEAR">
                            ...
                            <tr>
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:HiddenField ID="hdnYearSNo" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                                Year&nbsp; Code<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtYearCode" runat="server" Width="170px" Text="" /><asp:RequiredFieldValidator
                                                    ID="RequiredFieldValidator2" runat="server" SetFocusOnError="true" ErrorMessage="Year Code is required."
                                                    ControlToValidate="txtYearCode" ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                                Year&nbsp; Description<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtYearDesc" runat="server" Width="170px" Text="" /><asp:RequiredFieldValidator
                                                    ID="reqvalDeptIname" runat="server" SetFocusOnError="true" ErrorMessage="Year Description is required."
                                                    ControlToValidate="txtYearDesc" ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
