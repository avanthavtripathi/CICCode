<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="RegionMaster.aspx.cs" Inherits="Admin_RegionMaster" %>
                    ...
                    <td style="padding: 10px" align="center" colspan="2">
                         <table border="0" width="100%" >
                            ...
                            <td align="left" class="MsgTDCount">
                                ...
                                <asp:ListItem Text="Code" Value="Region_Code"></asp:ListItem>
                                <asp:ListItem Text="Description" Value="Region_Desc"></asp:ListItem>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        AllowSorting="True" DataKeyNames="Region_SNo" AutoGenerateColumns="False" ID="gvComm"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Region_Code" SortExpression="Region_Code" HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Left"
                            ...
                            <tr>
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <asp:HiddenField ID="hdnRegionSNo" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                            ...
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtRegionCode" runat="server" MaxLength="10" Width="170px"
                                                    Text="" /><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                        SetFocusOnError="true" ErrorMessage=" Region Code is required." ControlToValidate="txtRegionCode"
                                                        ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                                Region&nbsp; Description<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtRegionDesc" runat="server" MaxLength="100" Width="170px"
                                                    Text="" /><asp:RequiredFieldValidator ID="reqvalDeptIname" runat="server" SetFocusOnError="true"
                                                        ErrorMessage=" Region Description is required." ControlToValidate="txtRegionDesc" ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
