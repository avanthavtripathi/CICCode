<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="DefectMaster.aspx.cs" Inherits="Admin_DefectMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainConHolder" runat="Server">
    <asp:UpdatePanel ID="updatepnl" runat="server">
        <Triggers>
            <asp:PostBackTrigger ControlID="LbtnDownload" />
            <asp:PostBackTrigger ControlID="blkupload"></asp:PostBackTrigger>
<asp:PostBackTrigger ControlID="blkupload"></asp:PostBackTrigger>
        </Triggers>
        <ContentTemplate>
            <table width="100%">
                    ...
                    <td style="padding: 10px" align="center" colspan="2">
                        ...
                        <table width="100%" border="0">
                                ...
                                <td>
                                    ...
                                    <asp:GridView RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Category Code" Visible="false" DataField="Defect_Category_Code"
                                                SortExpression="Defect_Category_Code" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                            ...
                            <tr>
                                <td>
                                    <div align="left">
                                        <asp:Button ID="LbtnDownload" CssClass="btn" Width="100px" runat="server" Text="Download"
                                            OnClick="LbtnDownload_Click" Visible="False"></asp:Button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                                                            <asp:HyperLink ID="herfBulkUploadDefectMaster" runat="server" NavigateUrl="../bulkuploaded/BulkUploadDefectMaster.xls">Bulk Upload for Defect Master</asp:HyperLink>
                                                        </td>
                                                    </tr>
                                                </table>
                ...
                <tr>
                    <td>
                        <table>
                            <tr align="right">
                                <td align="right">
                                    <asp:FileUpload ID="bulkupload" runat="server" />
                                    &nbsp;&nbsp;&nbsp;<asp:Button ID="blkupload" runat="server" Text="Upload" OnClick="blkupload_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:GridView ID="bulkuploadgrid" runat="server">
                                    </asp:GridView>
                                </td>
                </tr>
            </table>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="blkupload" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
