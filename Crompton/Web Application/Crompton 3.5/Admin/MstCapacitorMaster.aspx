<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="MstCapacitorMaster.aspx.cs" Inherits="Admin_MstCapacitorMaster" Title="Crompton Greave : Capacitor Master" %>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        AllowSorting="True" DataKeyNames="Capacitor_SNo" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="SNo" HeaderStyle-Width="40px" DataField="Capacitor_SNo" />
                                            <asp:BoundField DataField="Unit_Desc" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Product Division" SortExpression="Unit_Desc"></asp:BoundField>
                                            <asp:BoundField DataField="ProductLine_Desc" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Product Line" SortExpression="ProductLine_Desc"></asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="Defect_Desc" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Defect Desc" SortExpression="Defect_Desc"></asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="Capacitor_name" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Capacitor/ Bearing Make" SortExpression="Capacitor_name"></asp:BoundField>
                                            <asp:BoundField DataField="Active_Flag" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Status" SortExpression="Active_Flag"></asp:BoundField>
                            ...
                            <tr>
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlDC" runat="server" CssClass="simpletxt1" ValidationGroup="editt"
                                                    AutoPostBack="True" OnSelectedIndexChanged="ddlDC_SelectedIndexChanged">
                                                </asp:DropDownList>
                                        ...
                                        <tr>
                                            <td width="30%">
                                                Capacitor Name <font color="red">*</font>
                                            </td>
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtCapacitor"
                                                    ErrorMessage="Capacitor Name is required." SetFocusOnError="true" ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
