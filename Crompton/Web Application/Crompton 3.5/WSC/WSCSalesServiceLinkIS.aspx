<%@ Page Language="C#" MasterPageFile="~/MasterPages/WSCCICPage.master" AutoEventWireup="true"
    CodeFile="WSCSalesServiceLinkIS.aspx.cs" Inherits="WSC_WSCSalesServiceLinkIS" %>
                   ...
                   <table border="0" cellspacing="0" cellpadding="0" >
                    ...
                    <tr id="tollFree" runat="server" visible="false" >
                       ...
                       <div style="text-align:center;font-weight:bold">OR</div>
                        <br />
                            <ul>
                        <li>  To speak to our customer service executive regarding any service
                            requirement ,Please dial our Toll Free Number <b>18004190505</b> (9.00 a.m. to 7.00 p.m.)
