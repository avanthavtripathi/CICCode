<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="WSCFeedbackType.aspx.cs" Inherits="WSC_WSCFeedbackType" %>
                            ...
                            <tr>
                                <td align="right">
                                    ...
                                    <asp:DropDownList ID="ddlSearch" runat="server" Width="130px" CssClass="simpletxt1">
                                        <asp:ListItem Text="Feedback Type" Value="WSCFeedback_Desc"></asp:ListItem>
                                    </asp:DropDownList>
                                    With
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        AllowSorting="True" DataKeyNames="WSCFeedbackID" AutoGenerateColumns="False" ID="gvComm"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="WSCFeedback_Desc" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Feedback Type" SortExpression="WSCFeedback_Desc">
                            ...
                            <tr>
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            <td width="30%">
                                                FeedBack Type<font color='red'>*</font>
                                            </td>
                                            <td>
                                                <asp:TextBox CssClass="txtboxtxt" ID="txtFeedBackType" runat="server" MaxLength="100"
                                                    Width="200px" Text="" /><asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                                        runat="server" SetFocusOnError="true" ErrorMessage="FeedBack Type is required."
                                                        ControlToValidate="txtFeedBackType" ValidationGroup="editt" ToolTip="FeedBack Type is required.."></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
