            ...
            <table width="100%" border="0">
             ...
             <td colspan="2">
               ...
               <tr>
                    ...
                    <tr>
                    <td style="width:100px;text-align:center">Region</td>
                    <td style="width:200px;text-align:center">Branch</td>
                    <td style="width:250px;text-align:center">SC Name</td>
                    
                    <td style="width:60px;text-align:center">Fans</td>
                    <td style="width:60px;text-align:center">Lighting</td>
                    <td style="width:60px;text-align:center">Pumps</td>
                    <td style="width:60px;text-align:center">Appliances</td>
                    <td style="width:60px;text-align:center">LT Motors</td>
                    <td style="width:60px;text-align:center">FHP Motors</td>
            
                    <td style="width:100px;text-align:center">Created Date </td>
                    </tr>
                    </table>
                    </div>
                       <div id="dvdash" runat="server" style="position:relative;height:450px;;overflow:auto;" >
                        <asp:GridView ID="gvReport" CssClass="simpletxt1" runat="server" RowStyle-CssClass="bgcolorcomm"
                            ...
                            <asp:BoundField DataField="Fans" HeaderText="Fans"  ItemStyle-Width="60px" />
                            <asp:BoundField DataField="Lighting" HeaderText="Lighting" ItemStyle-Width="60px" />
                            <asp:BoundField DataField="Pumps" HeaderText="Pumps"  ItemStyle-Width="60px" />
                            <asp:BoundField DataField="Appliances" HeaderText="Appliances" ItemStyle-Width="60px" />
