<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="MTODefectProduct.aspx.cs" Inherits="Reports_MTODefectProduct" %>
                            ...
                            <tr>
                                <td>
                                    <div id="divReport" style="width: 100%; height: 550px; overflow: auto">
                                        <rsweb:ReportViewer ID="rvMisDeatil" runat="server" Width="100%" Font-Names="Verdana"
                                            Font-Size="8pt" Height="500px" OnReportRefresh="rvMisDeatil_ReportRefresh">
                                        </rsweb:ReportViewer>
                                    </div>
                                </td>
                            </tr>
