...
public partial class Reports_AverageResolutionTimeReportBRWiseNew : System.Web.UI.Page
{
    ...
    {
        DataSet ds = objSql.ExecuteDataset(CommandType.StoredProcedure, "usp_AvgResolutionTimeReport_BRWise");
    ...
    private void FindheaderTextAndHide()
    {
        ...
        for (int i = 3; i < gvReport.Columns.Count; i++)
        {
