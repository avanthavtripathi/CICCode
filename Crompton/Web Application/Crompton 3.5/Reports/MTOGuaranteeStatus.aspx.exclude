<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="MTOGuaranteeStatus.aspx.cs" Inherits="Reports_MTOGuaranteeStatus" %>
                    ...
                    <td style="padding: 10px" align="center" colspan="2">
                        <table width="98%" border="0">
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlProductDivison" runat="server" Width="275px" CssClass="simpletxt1"
