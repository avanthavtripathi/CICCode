...
public partial class Reports_MTORatingWise : System.Web.UI.Page
{
    ...
    SqlParameter[] sqlParamSrh =
        {
            new SqlParameter("@Type","SELECT_PRODUCT_RATING_WISE"),
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        dsReport = objMTOReport.ReportData("RATINGWISE_REPORT");
        rvMisDeatil.LocalReport.ReportPath = "Reports\\BarReport\\RatingWiseReport.rdlc";
