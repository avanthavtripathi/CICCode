...
public partial class Reports_ComplaintResolutionReport : System.Web.UI.Page
{
       ...
       dt.Columns.Add(dc);
        ...
        foreach (GridViewRow gr in gvMIS.Rows)
        {
            ...
            foreach (TableCell tc in gr.Cells)
            {
                ...
                if (tc.Text == "Total")             // Bhawesh Added 30-6-13
                ...
                if (ci != 0 && ci != 13 && ci != 14)
                {
                    ...
                    if (status == "14" || status == "15" || status == "28" || status == "0") // status == "0" Bhawesh Added 30-6-13
                    {
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
       ...
       String stparam = "&regno=" + param[0].Value + "&branchsno=" + param[1].Value + "&pdivsno=" + param[2].Value + "&plinesno=" + param[3].Value + "&scsno=" + param[4].Value + "&callst=" + param[5].Value + "&warr=" + param[6].Value + "&IsCuYear=" + 1;
       ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspRepairReplacementReport1Process", param);   //"temp1", param) :: uspRepairReplacementReport
       BindGrid(ds,stparam);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        Context.Response.AddHeader("content-disposition", string.Format("attachment;filename={0}.xls", "ComplaintResolutionReport"));
