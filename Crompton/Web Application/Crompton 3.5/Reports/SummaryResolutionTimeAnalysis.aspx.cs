...
public partial class Reports_SummaryResolutionTimeAnalysis : System.Web.UI.Page
{    
    DataSet ds;
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=SummaryResolutionTimeAnalysis.xls");
            Response.ContentType = "application/ms-excel";
            System.IO.StringWriter stringWrite = new System.IO.StringWriter();
            System.Web.UI.HtmlTextWriter htmlWrite = new HtmlTextWriter(stringWrite);
            gvMIS.RenderControl(htmlWrite);
    ...
    //Add Code By Binay For MTS & MTO -19-11-2009
