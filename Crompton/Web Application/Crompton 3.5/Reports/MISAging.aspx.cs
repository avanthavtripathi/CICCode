...
public partial class Reports_MISAging : System.Web.UI.Page
{
    /// <summary>
    ...
    protected void BindGrid(string strOrder)
    {
        ...
        param[4].Value = int.Parse(ddlSC.SelectedValue.ToString());
        ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspSrfSitePendency", param);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=SRFSITEReport.xls");
