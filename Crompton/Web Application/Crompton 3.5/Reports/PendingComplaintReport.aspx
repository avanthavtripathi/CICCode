<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="PendingComplaintReport.aspx.cs" Inherits="Reports_PendingServiceRegistrationReport"
                ...
                <tr>
                    <td style="padding: 10px" align="center" colspan="2">
                        <table width="98%" border="0">
                            ...
                            <tr>
                                <td align="left">
                                    Note: Please use SaveToExcel for large range data.
                                </td>
                                <td align="left">
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        Visible="true" OnRowDataBound="gvComm_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UniqueContact_No" SortExpression="UniqueContact_No" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Contact_No.">
                                            ...
                                            <asp:BoundField DataField="Invoicedate" SortExpression="Invoicedate" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <asp:BoundField DataField="ComplaintAgeInhour" SortExpression="ComplaintAgeInhour"
                                                ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Left" HeaderText="Complaint Age Inhours">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                            ...
                            <tr id="trPaging">
                                <td>
                                    <asp:Repeater ID="repager" runat="server" OnItemCommand="repager_ItemCommand">
                                        <ItemTemplate>
                                            <asp:LinkButton Enabled='<%#Eval("Enabled") %>' Width="40px" BorderStyle="Ridge"
                                                Style="text-decoration: none; text-align: center;" runat="server" ID="lnkPageNo"
                                                Text='<%#Eval("Text") %>' CommandArgument='<%#Eval("Value") %>' CommandName="PageNo"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </td>
                            </tr>
