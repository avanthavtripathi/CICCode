...
CodeFile="OutBoundCallCustomerdissatisfcation.aspx.cs" Inherits="Reports_OutBoundCallCustomerdissatisfcation" 
            ...
            <table width="100%" border="0">
                <tr>
                    <td class="headingred" style="width: 40%">
                        OutBound Customer Dissatisfaction Survey Details
                    </td>
                           ...
                           >
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left"
                                  ...
                                  <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left" HeaderText="Complaint Closure Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lblClosedDate" runat="server"   Text='<%#Eval("WIPEndDate") %>'>
                                        </asp:Label>                                     
                                    </ItemTemplate>
                                </asp:TemplateField>
                                
                                  <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left" HeaderText="Customer Remarks">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCustomer_Remarks" runat="server" Text='<%#Eval("Customer_Remarks") %>'>
                                        </asp:Label>                                     
                                    </ItemTemplate>
                                </asp:TemplateField>
                                
                                  <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left"
                                    ItemStyle-HorizontalAlign="Left" HeaderText="ASC Remarks">
                                    <ItemTemplate>
                                        <asp:Label ID="lblASC_Remarks" runat="server" Text='<%#Eval("LastComment") %>'>
                                        </asp:Label>                                     
                                    </ItemTemplate>
                                </asp:TemplateField>                    
                    ...
                    <td colspan="2">
                        <asp:GridView ID="gvExport" CssClass="simpletxt1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                        ...
                                        <asp:BoundField DataField="Customer_Remarks"  HeaderText="Customer Remarks">
                                          
                                        </asp:BoundField> 
                                        
                                        <asp:BoundField DataField="LastComment"  HeaderText="Last Comments">
