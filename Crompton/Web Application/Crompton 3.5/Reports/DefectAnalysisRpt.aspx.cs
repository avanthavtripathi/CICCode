...
public partial class Reports_DefectAnalysisRpt : PersistViewStateToFileSystem
{
   ...
   // int intCnt = 0;
    ...
    private void BindData(string strOrder)
    {
        ...
        {
            sqlParamSrh[19].Value = Convert.ToString(ddlSerContractor.SelectedValue);
        }
        else
        {
            sqlParamSrh[19].Value = "0";
        }
