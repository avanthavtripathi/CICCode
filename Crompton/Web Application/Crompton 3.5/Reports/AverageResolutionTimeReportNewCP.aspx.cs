...
public partial class Reports_AverageResolutionTimeReportCP : System.Web.UI.Page
{
    ...
    {
        DataSet ds = objSql.ExecuteDataset(CommandType.StoredProcedure, "usp_AvgResolutionTimeReportCP"); //usp_AvgResolutionTimeReportCPvsIS
    ...
    private void FindheaderTextAndHide()
    {
        ...
        {
            if (listDict.ContainsKey(gvReport.Columns[i].HeaderText) && listDict.ContainsValue("CP") )
            {
