<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComplaintMISPopUp.aspx.cs"
    Inherits="Reports_ComplaintMISPopUp" %>
                               ...
                               <asp:GridView ID="gvMIS" CssClass="simpletxt1" runat="server" RowStyle-CssClass="gridbgcolor"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Sno" HeaderStyle-Width="40px" HeaderText="SNo">
                                       ...
                                       <asp:BoundField DataField="Region_desc" HeaderStyle-Width="100px" HeaderText="Region">
                                        <HeaderStyle Width="100px" />
                                    </asp:BoundField>
                                      <asp:BoundField DataField="branch_name" HeaderStyle-Width="100px" HeaderText="Branch">
                                        <HeaderStyle Width="100px" />
                                    </asp:BoundField>
