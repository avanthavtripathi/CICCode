<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintCallSlipIS.aspx.cs" Inherits="pages_PrintCallSlipIS" %>
...
<body onload="popup();">
    ...
    <div id="Divmsg" runat="server"  style="padding-top:20px; text-align:center; font-size:13px; font-weight:bold">
        <asp:Label ID="lblmsg" runat="server">
         Sorry! Yor are not authorized for IS division blank call slip
        </asp:Label>
        <br />
        ...
        <table width="680" align="center" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td colspan="4" style="padding: 40px; font-size: 12px">
                    <p align="center">
                        <u><b>Terms and Conditions</b></u></p>
                    <p>
                        &nbsp;</p>
