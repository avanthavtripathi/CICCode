<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="SCTR.aspx.cs" Inherits="pages_SCTR" MaintainScrollPositionOnPostback="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainConHolder" runat="Server">
    ...
    <asp:UpdatePanel ID="updateSC" runat="server">
        <ContentTemplate>
                    ...
                    <td style="padding: 10px" align="center" class="bgcolorcomm" colspan="3">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlSearchProductDivision" runat="server" CssClass="simpletxt1"
                                        Width="175">
                                        <asp:ListItem Value="0">Select</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtComplaintRefNo" Width="170" MaxLength="10" runat="server" CssClass="txtboxtxt"></asp:TextBox>
                                </td>
                                <td align="left">
                                    SRF:
                                </td>
                            ...
                            <tr>
                                <td align="center" colspan="4">
                                    <asp:GridView ID="gvFresh" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <%#Eval("ComplaintDate", "{0:dd/MM/yyyy}")%>
                                                    <%#Eval("ComplaintDate", "{0:T}")%>
                                    ...
                                    &nbsp;
                                    <asp:Button ID="btnPrint" runat="server" Text="Print Multiple" CssClass="btn" OnClientClick="alert('Please Use IE7/IE8 Or Firefox To Print Multiple Complaints.');"
                        ...
                        <table width="100%" class="bgcolorcomm" cellpadding="3" id="tbIntialization" runat="server"
                            ...
                            <tr id="trInitEngineer" visible="false" runat="server">
                                <td width="100%" height="20" align="left" style="padding-left: 200px">
                                    <table align="left" border="0" width="485px">
                                        <tr>
                                            <td align="left" width="150px">
                                                Engineer:<font color="red">*</font><asp:DropDownList ID="ddlServiceEngg" runat="server"
                                                    Width="100" CssClass="simpletxt1" ValidationGroup="init">
                                            ...
                                            <td align="right" width="167px">
                                                      ...
                                                      Date Visit :<font color="red">*</font>
                                                      <asp:TextBox ID="txtDateVisit" runat="server" CssClass="txtboxtxt" Width="100">
                                    </asp:TextBox>
                                                      <asp:RequiredFieldValidator ID="RFVDateVisit" runat="server" ControlToValidate="txtDateVisit" Display="None" ErrorMessage="Enter Date Visit " ValidationGroup="init">
                                    </asp:RequiredFieldValidator>
                                                      <cc1:CalendarExtender ID="CalendarExtender8" runat="server" TargetControlID="txtDateVisit">
                                                      </cc1:CalendarExtender>
                            ...
                            <tr>
                                <td align="left" style="padding-left: 200px">
                                    Remarks:<font color="red">*</font> &nbsp;<asp:TextBox ID="txtInitializationActionRemarks"
                                        Text="" runat="server" Width="405" CssClass="txtboxtxt"></asp:TextBox><asp:RequiredFieldValidator
                                            ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtInitializationActionRemarks"
                        ...
                        <div runat="server" id="tbBasicRegistrationInformation" style="display: none;">
                            <table width="100%" style="padding: 3px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblComplainNo" runat="server" Text=""></asp:Label>
                                    </td>
                                    <td align="right">
                                        Complaint Date:
                                    </td>
                                    <td align="left">
                                        <asp:Label ID="lblComplainDate" runat="server" Text=""></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="right">
                                     ...
                                     <td align="left">
                                        <asp:TextBox ID="txtInvoiceDate" onkeydown="return false;" onchange="InvoiceDateValidation()" ValidationGroup="AddTempGv" CssClass="txtboxtxt"
                                            runat="server">
                                        </asp:TextBox>
                        ...
                        <table width="99%" style="border: solid 1px #eeeeee;" visible="false" runat="server"
                            ...
                            <tr>
                                <td align="center">
                                    <asp:Button ID="btnAdd" runat="server" Width="100px" Text="Save/Add More" ValidationGroup="AddTempGv"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Complaint RefNo" HeaderStyle-HorizontalAlign="Left"
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="hdngvProduct_SerialNo" Value='<%#Bind("Product_SerialNo")%>'
                                                        runat="server" />
                                                    <asp:HiddenField ID="hdngvSLADate" runat="server" Value='<%#Eval("SLADate")%>' />
                                                    <%#Eval("Complaint_RefNo")%>/<%#Eval("SplitComplaint_RefNo")%><asp:HiddenField ID="hdngvDealerName"
                                                        Value='<%#Bind("DealerName")%>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                ...
                                <td align="center">
                                    ...
                                    <asp:GridView ID="gvViewDefects" runat="server" AllowPaging="True" DataKeyNames="Sno"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Winding Vendor" HeaderStyle-HorizontalAlign="Left"
                                                ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                        ...
                        <table width="100%" visible="false" runat="server" id="tbDefect" style="padding: 3px">
                            ...
                            <tr>
                                ...
                                <td colspan="3" align="left">
                                    <asp:Button ID="btnAddTempDefect" runat="server" CssClass="btn" OnClick="btnAddTempDefect_Click"
                        ...
                        <table width="99%" visible="false" runat="server" id="tbAction" style="padding: 3px">
                            ...
                            <tr id="TrReason" runat="server" visible="false">
                                <td align="right" valign="top" style="width: 30%">
                                    Reason of Replacement:<font color="red">*</font>
                                </td>
                                <td align="left">
                                    <asp:DropDownList ID="ddlReasonReplacement" runat="server" Width="417" CssClass="simpletxt1" />
                                    <asp:RequiredFieldValidator ID="RFVReasonReplacement" runat="server" ControlToValidate="ddlReasonReplacement"
                                        InitialValue="0" ErrorMessage="Select Reason" Display="None" ValidationGroup="SaveAction" />
                                </td>
                            </tr>
                            ...
                            <%--add by vivek --%>
                            <tr id="visitdate" runat="server" visible="false">
                                <td align="right" valign="top" style="width: 30%">
                                    Date Visit :<font color="red">*</font>
                                </td>
                                <td align="left" valign="top">
                                    <asp:TextBox ID="txtDateVisit" runat="server" onkeydown="return false;" onpaste="return false;"
                                        onkeypress="return false;" AutoPostBack="true" CssClass="txtboxtxt" Width="100"
                                        OnTextChanged="txtDateVisit_TextChanged">		
                                    </asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtDateVisit"
                                        Display="None" ErrorMessage="Enter Date Visit " ValidationGroup="SaveAction">		
                                    </asp:RequiredFieldValidator>
                                    <cc1:CalendarExtender ID="CalendarExtender9" runat="server" TargetControlID="txtDateVisit">
                                    </cc1:CalendarExtender>
                                </td>
                            </tr>
                            <tr id="trhappycode" runat="server" visible="false">
                                <td align="right" valign="top" style="width: 30%">
                                    HappyCode :<font color="red"></font>
                                </td>
                                <td align="left" valign="top">
                                    <asp:TextBox ID="txthappycode" MaxLength="6" runat="server" CssClass="txtboxtxt"
                                        Width="100"> </asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidatorhappycode" ControlToValidate="txthappycode"
                                        ValidationExpression="\d+" Display="Static" ValidationGroup="SaveAction" EnableClientScript="true"
                ...
                <div style="margin-left: 5px;">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnSubmitComplaint" Text="OK" runat="server" ValidationGroup="a"
                                    OnClick="btnSubmitComplaint_Click" CssClass="btn" />
                                <input type="button" id="btnCancelComplaint" name="Cancel" value="Cancel" onclick="CloseDiv(dvPopup,dvBlanket);"
                                    class="btn" />
                            </td>
                        </tr>
                    </table>
            ...
            <div id="dvConfirmDublicateProductSerial" runat="server" class="popUpDiv" style="display: block;
                height: 50px;">
                <div style="margin-left: 5px;">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td align="center">
                                <asp:Button ID="BtnConfirmYes" Text="YES" runat="server" OnClick="BtnConfirmYes_Click"
                                    CssClass="btn" />
