<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommunicationLog.aspx.cs"
                    ...
                    <div id="dvComments" runat="server">
                        ...
                        <tr>
                            ...
                            <div style="text-align:left;padding-left:200px;">
                             <asp:CheckBox ID="chkStatuscheck" runat="server" Checked="true" 
                                    Text="Status Check" Visible="False" />
                             </div>
                                <asp:TextBox ID="txtComment" runat="server" TextMode="MultiLine" Rows="4" Columns="50"
                               ...
                               <div>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtComment"
                                    ErrorMessage="Required." ValidationGroup="Comment" Display="Dynamic" 
                            ...
                            <td valign="bottom" style="width:300px">
                               <asp:CheckBox ID="chkEscalated" runat="server" Checked="false" Visible="false"
                                    Text="Escalated (Y/N)" />
                            </td>
                        </tr>
                        <tr>
