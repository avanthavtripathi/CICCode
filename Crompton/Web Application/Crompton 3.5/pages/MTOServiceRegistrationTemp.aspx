<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true" 
    CodeFile="MTOServiceRegistrationTemp.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="pages_MTOServiceRegistrationTemp" %>
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td ID="tdInvoiceNo" runat="server" visible="false">
                                                <asp:DropDownList ID="ddlInvoiceNo" runat="server" CssClass="simpletxt1" 
                                                    OnSelectedIndexChanged="ddlInvoiceNo_SelectedIndexChanged" AutoPostBack="true" Width="158px">
                                                </asp:DropDownList>
                                            </td>
                                            <td align="right" width="15%">
                                                Invoice No.:
                                            ...
                                            <td ID="tdProdctSRNO" runat="server" visible="false">
                                                <asp:DropDownList ID="ddlproductSRNO" runat="server" CssClass="simpletxt1" 
                                                    OnSelectedIndexChanged="ddlproductSRNO_SelectedIndexChanged" AutoPostBack="true" Width="158px">
                                                </asp:DropDownList>
                                            </td>
                                            <td>
                                                <asp:Button ID="BtnProcess" runat="server" CausesValidation="false" 
                                                    CssClass="btn" Enabled="true" OnClick="BtnProcess_Click" Text="Search" />
                        ...
                        <div ID="divCustomerInfo" runat="server" visible="false">
                            <table border="0" cellpadding="1" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td width="350px">
                                        <asp:TextBox ID="txtPMFirstName" runat="server" CssClass="txtboxtxt" 
                                            MaxLength="30" ReadOnly="true" Width="158px"></asp:TextBox>
                                    </td>
                                    <td align="right" width="120px">
                                        Last Name
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPMLastName" runat="server" CssClass="txtboxtxt" 
                                            MaxLength="20" ReadOnly="true" Width="158px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtPMCompanyName" runat="server" CssClass="txtboxtxt" 
                                            MaxLength="150" ReadOnly="true" Width="350Px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtPMAdd1" runat="server" CssClass="txtboxtxt" MaxLength="50" 
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtPMAdd2" runat="server" CssClass="txtboxtxt" MaxLength="49" 
                                            ReadOnly="true" Width="350px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                   <td id="tdAddress3" runat="server">
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtPMAdd3" runat="server" CssClass="txtboxtxt" MaxLength="150" 
                                            ReadOnly="true" Width="350px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        Country</td>
                                    <td style="width: 24%">
                                        <asp:DropDownList ID="ddlPMCountry" runat="server" AutoPostBack="True" 
                                            CssClass="simpletxt1" Enabled="false" 
                                            OnSelectedIndexChanged="ddlPMCountry_SelectedIndexChanged" Width="170px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 24%">
                                        <asp:DropDownList ID="ddlPMState" runat="server" AutoPostBack="True" 
                                            CssClass="simpletxt1" Enabled="false" 
                                            OnSelectedIndexChanged="ddlPMState_SelectedIndexChanged" Width="170px">
                                        </asp:DropDownList>
                                    </td>
                                    ...
                                    <td valign="top">
                                        <asp:DropDownList ID="ddlPMCity" runat="server" CssClass="simpletxt1" 
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtPMPinCode" runat="server" AutoPostBack="true" 
                                            CssClass="txtboxtxt" EnableViewState="true" MaxLength="6" 
                                            ReadOnly="true" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtPMPhone" runat="server" CssClass="txtboxtxt" MaxLength="11" 
                                ...
                                <tr>
                                    ...
                                    <td style="width: 24%">
                                        <asp:TextBox ID="txtPMEmail" runat="server" CssClass="txtboxtxt" 
                                            ReadOnly="true"></asp:TextBox>
                                    </td>
                                    <td align="right" style="width: 8%" valign="top">
                                        Fax No.
                                    ...
                                    <td valign="top">
                                        <asp:TextBox ID="txtPMFaxNo" runat="server" CssClass="txtboxtxt" 
                                            ReadOnly="true"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div id="divSiteInfo" runat="server" visible="true">
                            <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtAdd3" runat="server" CssClass="txtboxtxt" MaxLength="150"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:TextBox ID="txtPinCode" EnableViewState="true" 
                                         runat="server" AutoPostBack="false" CssClass="txtboxtxt" MaxLength="6" />
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Valid Contact Number is required."
                                            ...
                                            Display="None"></asp:RegularExpressionValidator>
                                            For example: 02267558912 for land line / 09821474747 for cell no
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <asp:UpdatePanel ID="pnlComplaint" runat="server">
                                        ...
                                        <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <asp:DropDownList Width="475px" ID="ddlProduct" AutoPostBack="false" runat="server" CssClass="simpletxt1" >
                                                        <asp:ListItem Selected="True" Text="Select" Value="0"></asp:ListItem>
                                                    </asp:DropDownList>
                                                    <asp:CompareValidator SetFocusOnError="true" ID="CompareValidator10" runat="server" ControlToValidate="ddlProduct"
                                                        ErrorMessage="Product is required." Operator="NotEqual" ValueToCompare="0"
                                                        Display="None"></asp:CompareValidator>
                                                        <asp:TextBox ID="txtFindPL" CssClass="txtboxtxt" runat="server"
                                                            Width="70" CausesValidation="false"></asp:TextBox>
                                                        <asp:Button ID="btnGoPL" runat="server" Width="88px" Text="Product Search" CssClass="btn" CausesValidation="false"  OnClick="btnGoPL_Click" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:CompareValidator SetFocusOnError="true" ID="CompareValidator14" runat="server" ControlToValidate="ddlRegion"
                                                        ErrorMessage="Region is required." Operator="NotEqual" ValueToCompare="0"
                                                        Display="None"></asp:CompareValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:CompareValidator SetFocusOnError="true" ID="CompareValidator6" runat="server" ControlToValidate="ddlBranch"
                                                        ErrorMessage="Branch is required." Operator="NotEqual" ValueToCompare="0"
                                                        Display="None"></asp:CompareValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <td colspan="4">
                                                <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox MaxLength="10" runat="server" ID="txtxPurchaseDate" ontextchanged="txtxPurchaseDate_TextChanged" AutoPostBack="true"
                                                                CssClass="txtboxtxt" />&nbsp;(mm/dd/yyyy)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td >
                                                            <asp:TextBox ID="txtxPurchaseFrom" runat="server" CssClass="txtboxtxt" ValidationGroup="Report" Visible="false" />
                                                        </td>
                                                        <td align="right"> Product SR No. &nbsp;
                                                        </td>
                                                        <td>
                                                           ...
                                                           <%-- <asp:RequiredFieldValidator ID="reqPrdSRNo"  runat="server" Display="None" ErrorMessage="Product SR No is required"
                                                                SetFocusOnError="true"  ControlToValidate="txtPrdSRNo"></asp:RequiredFieldValidator>--%>
                                                        </td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td>
                                                            Manufacture Date <%--PO Date--%>
                                                        </td>
                                                        <td >
                                                            <asp:TextBox MaxLength="10" runat="server" ID="txtPoDate" CssClass="txtboxtxt" ReadOnly="true" />&nbsp;(mm/dd/yyyy)
                                                            <cc1:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtPoDate">
                                                            </cc1:CalendarExtender>
                                                        ...
                                                        <td><asp:TextBox MaxLength="10" runat="server" ID="txtDateofDispatch" SetFocusOnError="true"  
                                                                CssClass="txtboxtxt" />&nbsp;(mm/dd/yyyy)<asp:CompareValidator ID="CompareValidator9" runat="server"
                                                                    Type="Date" Operator="DataTypeCheck" ControlToValidate="txtDateofDispatch" Display="None"
                                                                    ErrorMessage="Valid date is required. "></asp:CompareValidator>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox MaxLength="10" runat="server" ID="txtCommissionDate" 
                                                                CssClass="txtboxtxt" />&nbsp;(mm/dd/yyyy)
                                                       ...
                                                       <%-- </td>
                                                        <td style="width: 21%">--%>
                                                            <asp:TextBox MaxLength="10" runat="server" ID="txtWarrantyDate" CssClass="txtboxtxt" ReadOnly="true" />&nbsp;(mm/dd/yyyy)
                                                    ...
                                                    <tr id="trAllocateTo" runat="server" visible="true">
                                                        <td>Allocate To</td>
                                                        <td><asp:DropDownList ID="ddlAllocateTo" runat="server" CssClass="simpletxt1" 
                                                                OnSelectedIndexChanged="ddlAllocateTo_SelectedIndexChanged" AutoPostBack="true">
                                                                <asp:ListItem Selected="True" Text="Select" Value="0"></asp:ListItem>
                                                       ...
                                                       <td id="tdAllocate" runat="server" visible="false" >
                                                            <asp:DropDownList ID="ddlSC" runat="server" CssClass="simpletxt1" Width="250px" >
                                                            </asp:DropDownList>
                                                            <asp:CompareValidator SetFocusOnError="true" ID="CompareValidator11" runat="server" ControlToValidate="ddlSC"
                                                                ErrorMessage="Service Contractor is required." Operator="NotEqual" ValueToCompare="0"
                                                                Display="None"></asp:CompareValidator>
                                                                
                                                            <asp:DropDownList ID="ddlCGExec" Visible="false" runat="server" CssClass="simpletxt1" Width="175px" >  
                                                            </asp:DropDownList>
                                                            <asp:CompareValidator SetFocusOnError="true" ID="CompareValidator12" runat="server" ControlToValidate="ddlCGExec"
                                                                ErrorMessage="CG Employee is required." Operator="NotEqual" ValueToCompare="Select"
                                                                Display="None"></asp:CompareValidator>
                                                                
                                                            <asp:DropDownList ID="ddlCGContractEmp" runat="server" CssClass="simpletxt1" Width="175px" >  
                                                            </asp:DropDownList>
                                                            <asp:CompareValidator SetFocusOnError="true" ID="CompareValidator13" runat="server" ControlToValidate="ddlCGContractEmp"
                                                                ErrorMessage="CG Contract Employee is required." Operator="NotEqual" ValueToCompare="Select"
                                                                Display="None"></asp:CompareValidator>
                                                        </td>
                                                        
                                                    </tr>
                                                    <tr id="trAllocateToMySelf" runat="server" visible="true">
                                                    <td>Allocate To Myself</td>
                                                    <td> <asp:CheckBox ID="chkSelfAllocatopn" runat="server" AutoPostBack="True" 
                                                            oncheckedchanged="chkSelfAllocatopn_CheckedChanged"/></td>
                                                    </tr>
                                                </table>
                                            </td>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <asp:GridView PageSize="10" DataKeyNames="SnoDisp" RowStyle-CssClass="gridbgcolor"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="PurchasedFromDisp" Visible="false" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <tr>
                                                <td colspan="4" align="center">
                                                    <asp:Button ID="btnSubmit" runat="server" CausesValidation="false"  CssClass="btn" Text="Save" Width="70px" 
                                                    ...
                                                    <asp:Button ID="btnCancel" runat="server" CssClass="btn" Text="Cancel" 
                                                        OnClick="btnCancel_Click" OnClientClick="return funConfirm();"  />
                                                    &nbsp;
