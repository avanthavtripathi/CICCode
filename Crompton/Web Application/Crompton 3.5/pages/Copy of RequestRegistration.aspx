<%@ Page Language="C#" MasterPageFile="~/MasterPages/CICPage.master" AutoEventWireup="true"
    CodeFile="Copy of RequestRegistration.aspx.cs" MaintainScrollPositionOnPostback="true"
                                                    ...
                                                    <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td colspan="3">
                                                                ...
                                                                <asp:GridView ID="gvCustomerList" runat="server" PageSize="15" RowStyle-CssClass="gridbgcolor"
                                                                    AlternatingRowStyle-CssClass="fieldName" DataKeyNames="CustomerId" HeaderStyle-CssClass="fieldNamewithbgcolor"
                                                                    AutoGenerateColumns="False" BorderStyle="None" GridLines="none" Width="100%"
                                                                    OnPageIndexChanging="gvCustomerList_PageIndexChanging" OnSelectedIndexChanging="gvCustomerList_SelectedIndexChanging">
                                                                    <Columns>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <%--added by vikas on 15 May 2013--%>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvSOC" runat="server" ControlToValidate="ddlSourceOfComp"
                                                                ErrorMessage="Required." SetFocusOnError="True" InitialValue="0" Display="None"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td style="width: 8%"> <%--added by vikas on 15 May 2013--%>
                                                            <asp:Label ID="lblComplaintType" Visible="false" runat="server" Text="Type Of Complaint"></asp:Label>
                                                        </td>
                                                        <td> <%--added by vikas on 15 May 2013--%>
                                                            <asp:DropDownList ID="ddlDealer" runat="server" Visible="false">
                                                                <asp:ListItem Text="Complaint for Dealer Stock Piece" Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="Complaint for customer Piece" Value="2"></asp:ListItem>
                                                                <asp:ListItem Text="Complaint for another Dealer or Retailer Piece" Value="3"></asp:ListItem>
                                                            </asp:DropDownList>
                                                            <asp:DropDownList ID="ddlASC" runat="server" Visible="false">
