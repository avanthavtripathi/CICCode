...
public partial class pages_RequestRegistration : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if (Page.IsValid)
        //{
        //    string strProcessScript = "this.value='Please wait..';this.disabled=true;";
    ...
    private void CreateRow()
    {
        ...
        if (!blnFlag)    // If record is not already exist for correspodning product division then save it
        {
            ...
            if (ddlSourceOfComp.SelectedItem.Text == "Customer") //added By vikas  07 May 2013
            {
                dRow["SourceOfcomp"] = ddlSourceOfComp.SelectedValue.ToString();
                dRow["TypeOfComplaint"] = "";
            }
            else if (ddlSourceOfComp.SelectedItem.Text == "Dealer") //added By vikas  07 May 2013
            {
                dRow["SourceOfcomp"] = ddlSourceOfComp.SelectedValue.ToString();
                dRow["TypeOfComplaint"] = ddlDealer.SelectedItem.Text.ToString();
            }
            else //added By vikas  07 May 2013
            {
                dRow["SourceOfcomp"] = ddlSourceOfComp.SelectedValue.ToString();
                dRow["TypeOfComplaint"] = ddlASC.SelectedItem.Text.ToString();
            }
            dTableFile = (DataTable)ViewState["dTableFile"];
