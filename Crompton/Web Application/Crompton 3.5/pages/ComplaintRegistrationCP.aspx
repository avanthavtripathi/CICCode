                                                            ...
                                                            <asp:Panel ID="tblenable" runat="server">
                                                                <table width="100%" border="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                            <asp:TextBox runat="server" MaxLength="50" Width="350Px" CssClass="txtboxtxt" ID="txtAdd1"  onkeypress="return blockSpecialChar(event)"></asp:TextBox>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                            <asp:TextBox ID="txtAdd2" runat="server" CssClass="txtboxtxt" MaxLength="50" Width="350px" onkeypress="return blockSpecialChar(event)"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                            <asp:TextBox ID="txtContactNo" Width="213px" MaxLength="10" placeholder="Please enter 10-digit Mobile # ONLY" runat="server" CssClass="txtboxtxt"></asp:TextBox>
                                                                           <%-- <p style="0">Please Enter Mobile No only to <br />recive feedback code</p>--%>
...
//    {
//    
//    var str = document.getElementById('<%=txtAdd1.ClientID%>');
//    var str2 = document.getElementById('<%=txtAdd2.ClientID%>');
//          alert(str.value + str2.value);
//          if((/^[a-zA-Z0-9- ]*$/.test(str) == false)||(/^[a-zA-Z0-9- ]*$/.test(str2) == false))   {
//   
