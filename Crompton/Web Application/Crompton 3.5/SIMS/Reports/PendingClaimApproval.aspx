<%@ Page Language="C#" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master" AutoEventWireup="true"
    CodeFile="PendingClaimApproval.aspx.cs" Inherits="SIMS_Reports_PendingClaimApproval" %>
                    ...
                    <td style="padding: 10px" align="center" colspan="2">
                        <table width="98%" border="0">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlProductDivison" runat="server" Width="175px" CssClass="simpletxt1" AutoPostBack="true"
                              ...
                              <%--add by sandeep--%>
                            <tr>
                            <td width="30%" align="right">Product Line</td>
                            <td align="left">
                                <asp:DropDownList ID="ddlProductLine" runat="server" Width="175px"  AutoPostBack="true"
                                    CssClass="simpletxt1" 
                            ...
                            <tr>
                            <td width="30%" align="right">Defect Category</td>
                            <td align="left">
                                <asp:DropDownList ID="ddlDefectCategory" runat="server" Width="175px" AutoPostBack="true" 
                                    CssClass="simpletxt1" 
                                    onselectedindexchanged="ddlDefectCategory_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            </tr>
                            
                            <tr>
                            <td width="30%" align="right">Defect</td>
                            <td align="left">
                                <asp:DropDownList ID="ddldefect" runat="server" Width="175px" 
                                    CssClass="simpletxt1" onselectedindexchanged="ddldefect_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            </tr>
                             <tr>
                                            ...
                                            <asp:TemplateField SortExpression="Complaint_No" HeaderStyle-HorizontalAlign="Left"
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lblcomplaint" CommandName="stage" runat="server" CommandArgument='<%#Eval("BASELINEID")%>'
                                                        Text='<%#Eval("Complaint_No") %>' OnClick="lblcomplaint_Click"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
