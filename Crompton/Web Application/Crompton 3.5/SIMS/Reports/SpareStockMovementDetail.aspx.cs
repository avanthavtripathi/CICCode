...
public partial class SIMS_Reports_SpareStockMovementDetail : System.Web.UI.Page
{
    SpareStockMovementDetail objSpareStockMovementDetail = new SpareStockMovementDetail();
    ...
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        objSpareStockMovementDetail.Vendor_Id = Convert.ToInt32(ddlVendor.SelectedValue);
        objSpareStockMovementDetail.ASC_Id = Convert.ToInt32(ddlASC.SelectedValue);
    ...
    protected void ddlProductDivison_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            objSpareStockMovementDetail.ASC_Id = Convert.ToInt32(ddlASC.SelectedValue);
            objSpareStockMovementDetail.ProductDivision_Id = Convert.ToInt32(ddlProductDivison.SelectedValue);
            objSpareStockMovementDetail.BindDDLVendor(ddlVendor); // bhawesh added 23 apr 12
    ...
    {
        objSpareStockMovementDetail.ProductDivision_Id = Convert.ToInt32(ddlProductDivison.SelectedValue);
        objSpareStockMovementDetail.SpareSearch = txtsparesearch.Text.Trim();
        objSpareStockMovementDetail.BindSpareCodeData(ddlSpareCode);
        txtsparesearch.Text = "";
    }
}
