...
public partial class SIMS_Reports_simsinvoiceNew : System.Web.UI.Page
{
    ...
    public DataSet PaymentMaster()
    {
        ...
        SqlParameter[] sqlParamI =
        {
                ...
                new SqlParameter("@iscarryforward",carryforward)
    ...
    protected void calculate()
    {
        try
        {
            ...
            DataSet ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "usp_GenenerateInvoiceForFanSC", param);
