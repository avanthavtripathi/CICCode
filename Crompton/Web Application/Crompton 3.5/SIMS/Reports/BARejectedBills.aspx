<%@ Page Language="C#" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master" AutoEventWireup="true" CodeFile="BARejectedBills.aspx.cs" Inherits="SIMS_Reports_BARejectedBills" Title="Untitled Page" %>
...
<asp:Content ID="cntbabills" ContentPlaceHolderID="MainConHolder" Runat="Server">
 <script language="javascript" type="text/javascript">
    function funReqDetail(compNo) {
             var strUrl='SIMS/Pages/InternalBillProcess.aspx?billno='+ compNo;
...
<asp:PostBackTrigger ControlID ="BtnExportExcel" />
        ...
        <ContentTemplate>
            <table width="100%">
                <tr>
                    <td class="headingred">
                      Rejected Bills By Branch Accounts
                    </td>
                            ...
                            <tr>
                                <td>
                                      ...
                                      <ItemTemplate>
                                       <a href="Javascript:void(0);" onclick='funReqDetail(<%#Eval("InternalBillNo")%>)'>
                                          ...
                                          <asp:BoundField DataField="InternalBillNo" HeaderStyle-Width="60px"
                                                ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderText="Internal Bill No">
                                                <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="InternamlBillAmount" HeaderStyle-Width="60px"
                                               ...
                                               <asp:BoundField DataField="rejectedClaims" HeaderStyle-Width="60px"
                                                ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderText="Rejected Claims">
                                                <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                                <asp:BoundField DataField="ba_comment" HeaderStyle-Width="60px"
                                                ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderText="Rejected Reason">
                                                <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                        </Columns>
                                    ...
                                    <asp:GridView RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        HeaderStyle-CssClass="fieldNamewithbgcolor" GridLines="both"
                                        AutoGenerateColumns="false" ID="gvExport"
                                        runat="server" Width="100%" HorizontalAlign="Left"   >
                                        <RowStyle CssClass="gridbgcolor" />
                                        <Columns>
                                       <asp:BoundField DataField="unit_desc"  HeaderStyle-Width="60px"
