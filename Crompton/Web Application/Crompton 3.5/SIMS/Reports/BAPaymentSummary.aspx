<%@ Page Language="C#" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master" AutoEventWireup="true" CodeFile="BAPaymentSummary.aspx.cs" Inherits="SIMS_Reports_BAPaymentSummary" Title="Untitled Page" EnableEventValidation="false" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="cntpaysumm" ContentPlaceHolderID="MainConHolder" Runat="Server">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                      ...
                                      <ItemTemplate>
                                       <a href="Javascript:void(0);" onclick='funReqDetail(<%#Eval("InternalBillNo")%>)'>
                                                                                      <%#Eval("InternalBillNo")%> </a>
                                          ...
                                          <HeaderStyle Width="150px" />
                                            ...
                                            <asp:BoundField DataField="ASCBillAmount" 
                                              ...
                                              <asp:BoundField DataField="Miscellaneous1" 
                                                HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Miscellaneous1">
                                                <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                              <asp:BoundField DataField="Miscellaneous2" 
                                                HeaderStyle-Width="60px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left"
                                                HeaderText="Miscellaneous2">
                                                <HeaderStyle HorizontalAlign="Left" Width="60px" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="TransationDate" ItemStyle-HorizontalAlign="Left"
                                             ...
                                             <asp:BoundField DataField="FinalAmount" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Final Amt PUSH to SAP">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             ...
                                             <asp:BoundField DataField="IsDownloaded" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="PUSH to SAP (file downloaded)">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="DownloadedDate" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="PUSH to SAP (file downloaded date)">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
