<%@ Page Language="C#" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master" AutoEventWireup="true" CodeFile="Newsimsinvoice.aspx.cs" Inherits="SIMS_Reports_Newsimsinvoice" Title="Untitled Page" %>
                ...
                <div id="dvInvoicecontent" runat="server">
                    ...
                    <table width="100%" style="border: 1px solid #b5b5b6!important; color: Black; border-collapse: collapse;"
                        ...
                        <tr>
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center" class="style1">
                                <asp:Label ID="lblLWHU18" runat="server" value="185.00">185.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center" class="style1">
                                <asp:Label ID="lblLWHU24" runat="server" value="170.00">170.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center" class="style1">
                                <asp:Label ID="lblLWHU72" runat="server" value="150.00">150.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center" class="style1">
                                <asp:Label ID="lblLWHU120" runat="server" value="125.00">125.00</asp:Label>
                            </td>
                            <%-------------------------%>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center" class="style1">
                                <asp:Label ID="lblLWHU72120" runat="server" value="100.00">100.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center" class="style1">
                                <asp:Label ID="lblLWHUgreater120" runat="server" value="75.00">75.00</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHU18" runat="server" value="175.00">175.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHU24" runat="server" value="160.00">160.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHU72" runat="server" value="140.00">140.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHU120" runat="server" value="115.00">115.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHU72120" runat="server" value="90.00">90.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHUgreater120" runat="server" value="65.00">65.00</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="2" style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHU18" runat="server" value="350.00">350.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHU24" runat="server" value="350.00">350.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHU72" runat="server" value="350.00">350.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHU120" runat="server" value="300.00">300.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHU72120" runat="server" value="250.00">250.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHUgreater120" runat="server" value="160.00">160.00</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHU18" runat="server" value="340.00">340.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHU24" runat="server" value="340.00">340.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHU72" runat="server" value="340.00">340.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHU120" runat="server" value="290.00">290.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHU72120" runat="server" value="240.00">240.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHUgreater120" runat="server" value="150.00">150.00</asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table width="100%" style="border: 1px solid #b5b5b6!important; color: Black; border-collapse: collapse;"
                        ...
                        <tr>
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="txtLWOH72" runat="server"></asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                        ...
                        <tr>
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="txtOWOH72" runat="server"></asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                    ...
                    <table width="100%" style="border: 1px solid #b5b5b6!important; color: Black; border-collapse: collapse;"
                        ...
                        <tr>
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWHARep18" runat="server">100.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWHARep24" runat="server">100.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWHARep72" runat="server">100.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWHARep120" runat="server">100.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWHARep72120" runat="server">100.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWHARepgreater120" runat="server">100.00</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHARep18" runat="server">90.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHARep24" runat="server">90.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHARep72" runat="server">90.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHARep120" runat="server">90.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHARep72120" runat="server">90.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblLWOHARepgreater120" runat="server">90.00</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="2" style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHARep18" runat="server">250.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHARep24" runat="server">250.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHARep72" runat="server">250.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHARep120" runat="server">250.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHARep72120" runat="server">250.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWHARepgreater120" runat="server">250.00</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                            ...
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHARep18" runat="server">240.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHARep24" runat="server">240.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHARep72" runat="server">240.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHARep120" runat="server">240.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHARep72120" runat="server">240.00</asp:Label>
                            </td>
                            <td style="padding: 2px 5px; border: 1px solid #c4c5c6;" align="center">
                                <asp:Label ID="lblOWOHARepgreater120" runat="server">240.00</asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table width="100%" style="border: 1px solid #b5b5b6!important; color: Black; border-collapse: collapse;"
