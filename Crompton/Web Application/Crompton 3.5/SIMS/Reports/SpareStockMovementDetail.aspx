<%@ Page Language="C#" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master" AutoEventWireup="true"
    CodeFile="SpareStockMovementDetail.aspx.cs" Inherits="SIMS_Reports_SpareStockMovementDetail"
    ...
    <asp:UpdatePanel ID="updatepnl" runat="server">
        ...
        <ContentTemplate>
            <table width="100%">
                <tr>
                    <td class="headingred">
                        Spare Stock Movement Detail Report
                    </td>
                        ...
                        <table width="98%" border="0">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    </asp:DropDownList><asp:TextBox ID="txtsparesearch" runat="server" CssClass="txtboxtxt" Width="60px"></asp:TextBox>
                                    <asp:Button ID="btnSpareSearch" runat="server" Text="Go" CssClass="btn" 
                                        onclick="btnSpareSearch_Click" />
                                </td>
                            </tr>
                              <tr>
                                <td width="30%" align="right">
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlVendor"  runat="server" Width="175px" CssClass="simpletxt1"
                                        ValidationGroup="editt">
                                    ...
                                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Spare" SortExpression="Spare" HeaderStyle-Width="100px"
                                             ...
                                             <asp:BoundField DataField="Vendor_name" SortExpression="Vendor_name" HeaderStyle-Width="100px"
                                                ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderText="Vendor">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="Transaction Detail" SortExpression="Transaction Detail"
                                                ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderText="Transaction Detail">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="Transaction Date" SortExpression="Transaction Date"
                                                ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" HeaderText="Transaction Date">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Opening Stock" SortExpression="Opening Stock" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Opening Stock">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Stock Receipts" SortExpression="Stock Receipts" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Stock Receipts">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Stock Issued" SortExpression="Stock Issued" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Stock Issued">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Closing Stock" SortExpression="Closing Stock" ItemStyle-HorizontalAlign="Left"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Closing Stock">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                        </Columns>
