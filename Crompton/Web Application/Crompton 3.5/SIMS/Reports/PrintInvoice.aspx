    ...
    <div id="dvInvoiceDetails" runat="server" >
        ...
        <table width="100%">
            <tr>
                ...
                <td align="center" rowspan="3" style="display:none"> <%--change for 30 jun 2017--%>
            ...
            <tr style="display:none"> <%--30 jun 2017--%>
                <td align="left">
                    Invoice for :
        ...
        <div id="dvInvoicecontent" runat="server" style="margin:0px 15px 0px 15px;">
                    ...
                    <td>
                        <table width="99%">
                            <tr id="TrInvoiceHideShow" runat="server">
                                ...
                                <td style="width:9%; display:none"> <%--30 jun 2017--%>
                                    Invoice No
                                </td>
                                <td style="width:29%">
            ...
            <table width="90%" style="width: 100%; border: 1px solid #b5b5b6!important; color: Black;
               ...
               <tr>
                ...
                <tr id="trTaxDetails" runat="server" style="display:none"> <%--30 jun 2017--%>
                    <td style="padding: 2px 5px; border: 1px solid #c4c5c6; width: 75%;" colspan="3"
                        align="right">
