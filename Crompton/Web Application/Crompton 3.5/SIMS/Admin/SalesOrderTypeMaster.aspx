<%@ Page Language="C#" MasterPageFile="~/SIMS/MasterPages/SIMSCICPage.master" AutoEventWireup="true"
    CodeFile="SalesOrderTypeMaster.aspx.cs" Inherits="SIMS_Admin_SalesOrderTypeMaster" %>
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <asp:DropDownList ID="ddlSearch" runat="server" Width="160px" CssClass="simpletxt1">
                                        <asp:ListItem Text="Sales Order Type Code" Value="Sales_Order_Type_Code"></asp:ListItem>
                                        <asp:ListItem Text="Sales Order Type Desc" Value="Sales_Order_Type_Desc"></asp:ListItem>
                                    </asp:DropDownList>
                                    With
                            ...
                            <tr>
                                <td class="bgcolorcomm">
                                    <asp:GridView ID="gvComm" runat="server" AllowPaging="True" AllowSorting="True" AlternatingRowStyle-CssClass="fieldName"
                                        AutoGenerateColumns="False" DataKeyNames="Sales_Order_Type_Id" GridGroups="both"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Sales_Order_Type_Code" SortExpression="Sales_Order_Type_Code"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Sales Order Type Code" ItemStyle-HorizontalAlign="Left">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Sales_Order_Type_Desc" SortExpression="Sales_Order_Type_Desc"
                                                HeaderStyle-HorizontalAlign="Left" HeaderText="Sales Order Type Desc" ItemStyle-HorizontalAlign="Left">
                            ...
                            <tr>
                                <td width="100%" align="left" class="bgcolorcomm">
                                    <table width="98%" border="0">
                                        ...
                                        <tr>
                                            <td width="25%">
                                                Sales Order Type Code:<font color='red'>*</font>
                                            </td>
                                            <td colspan="2">
                                                ...
                                                <asp:RequiredFieldValidator ID="RFStateDesc" runat="server" SetFocusOnError="true"
                                                    ErrorMessage="Sales Order Type Code is required." Display="Dynamic" ControlToValidate="txtCode"
                                                    ValidationGroup="editt"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                Sales Order Type Description:<font color='red'>*</font>
                                            </td>
                                            <td colspan="2">
                                                <asp:TextBox CssClass="txtboxtxt" MaxLength="100" ID="txtDescription" runat="server"
                                                    Width="170px" Text="" />&nbsp;
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" SetFocusOnError="true"
                                                    ErrorMessage="Sales Order Type Description is required." ControlToValidate="txtDescription"
                                        ...
                                        <tr>
                                            <td colspan="3" align="left" style="padding-left: 230px">
                                                <table>
                                                    <tr>
                                                        <td align="right">
