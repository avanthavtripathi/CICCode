...
public partial class SIMS_Admin_SIMSServiceContractorMaster : System.Web.UI.Page
{
    SIMSCommonClass objCommonClass = new SIMSCommonClass();
    SIMSServiceContractorMaster objServiceContractorMaster = new SIMSServiceContractorMaster();
    ...
    protected void ddlRegion_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            objServiceContractorMaster.BindBranchBasedonRegionSNo(ddlBranch, int.Parse(ddlRegion.SelectedValue.ToString())); //objBranchMaster.BindBranchBasedonRegionSNo(ddlBranch, int.Parse(ddlRegion.SelectedValue.ToString()));
            objServiceContractorMaster.BindBranchPlantBasedonRegionSNo(ddlBranchPlant, int.Parse(ddlRegion.SelectedValue.ToString()));
        }
        else
        {
    ...
    private void BindSelected(int intSCSNo)
    {
        ...
        txtSAPCustomerCode.Text = objServiceContractorMaster.SAP_Customer_Code;
        txtSAPVendorCode.Text = objServiceContractorMaster.SAP_Vendor_Code;
        ...
        if (ddlRegion.SelectedIndex != 0)
        {
            ...
            for (int intCnt = 0; intCnt < ddlBranchPlant.Items.Count; intCnt++)
            {
                if (ddlBranchPlant.Items[intCnt].Value.ToString() == objServiceContractorMaster.BranchPlantSNo.ToString())
                {
                    ddlBranchPlant.SelectedIndex = intCnt;
                }
            }
        }
        else
        {
            ...
            ddlBranchPlant.Items.Clear();
            ddlBranchPlant.Items.Insert(0, new ListItem("Select", "0"));
        }
        ...
        ddlCreditNoteGenerationDay.SelectedIndex = 0;
        for (int intCnt = 0; intCnt < ddlCreditNoteGenerationDay.Items.Count; intCnt++)
        {
            if (ddlCreditNoteGenerationDay.Items[intCnt].Value.ToString() == objServiceContractorMaster.CreditNoteGenerationDay.ToString())
            {
                ddlCreditNoteGenerationDay.SelectedIndex = intCnt;
            }
        }
        txtCreditNoteThreshold.Text =Convert.ToString(objServiceContractorMaster.CreditNoteThresholdAmount);
        txtECCNumber.Text = Convert.ToString(objServiceContractorMaster.ECC_Number);
        txtTINNumber.Text = Convert.ToString(objServiceContractorMaster.TIN_Number);
    ...
    protected void imgBtnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            if (hdnSCSNo.Value != "")
            {
                ...
                objServiceContractorMaster.SCCode = txtScCode.Text.Trim();
                objServiceContractorMaster.SCName = txtScName.Text.Trim();
                objServiceContractorMaster.SAP_Customer_Code = txtSAPCustomerCode.Text.Trim();
                objServiceContractorMaster.SAP_Vendor_Code = txtSAPVendorCode.Text.Trim();
                objServiceContractorMaster.ContactPerson = txtContactPerson.Text.Trim();
                objServiceContractorMaster.Address1 = txtAddOne.Text.Trim();
                objServiceContractorMaster.Address2 = txtAddTwo.Text.Trim();
                objServiceContractorMaster.RegionSNo = int.Parse(ddlRegion.SelectedValue.ToString());
                ...
                objServiceContractorMaster.BranchPlantSNo = ddlBranchPlant.SelectedValue.ToString();
                objServiceContractorMaster.CreditNoteThresholdAmount = txtCreditNoteThreshold.Text.Trim();
                objServiceContractorMaster.CreditNoteGenerationDay = ddlCreditNoteGenerationDay.SelectedValue.ToString();
                objServiceContractorMaster.ECC_Number = txtECCNumber.Text.Trim();
                objServiceContractorMaster.TIN_Number = txtTINNumber.Text.Trim();
    ...
    private void ClearControls()
    {
       // imgBtnAdd.Visible = true;
        ...
        txtScCode.Text = "";
        txtScName.Text = "";
        txtSAPCustomerCode.Text = "";
        txtSAPVendorCode.Text = "";
