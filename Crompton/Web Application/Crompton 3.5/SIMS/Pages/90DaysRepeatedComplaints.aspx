<%@ Page Language="C#" AutoEventWireup="true" CodeFile="90DaysRepeatedComplaints.aspx.cs"
    Inherits="SIMS_Pages_90DaysRepeatedComplaints" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function funUserDetail(custNo, compNo) {
            ...
            window.open(strUrl, 'History', 'height=550,width=750,left=20,top=30,scrollbars=1');
        }

        function funOpenComplaints(BaseLineId) {
            var strUrl = '../../pages/PopUp.aspx?BaseLineId=' + BaseLineId;
            window.open(strUrl, 'Complaint', 'height=600,width=950,left=20,top=30,scrollbars=1');
        }
    </script>
</head>
<body>
                    ...
                    <asp:GridView PageSize="10" RowStyle-CssClass="gridbgcolor" AlternatingRowStyle-CssClass="fieldName"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"
                                ...
                                <ItemTemplate>
                                    <a href="Javascript:void(0);" id="Copmlaint_Ref" onclick="funOpenComplaints(<%#Eval("BaseLineId")%>)">
