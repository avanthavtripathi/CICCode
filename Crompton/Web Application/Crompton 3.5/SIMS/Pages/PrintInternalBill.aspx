<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintInternalBill.aspx.cs"
    Inherits="SIMS_Pages_PrintInternalBill" %>
...
<script type="text/javascript">
        function closePopup()
        {                 
            window.opener.location.href ="GenerateInternalBill.aspx?ReturnId=True";
            window.close();
        }
        </script>
