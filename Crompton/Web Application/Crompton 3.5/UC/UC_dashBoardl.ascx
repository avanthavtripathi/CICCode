<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_dashBoardl.ascx.cs"
    Inherits="UC_UC_dashBoardl" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="background-color: White">
    ...
    <tr>
        <td align="center" colspan="2" style="width: 100%">
            ...
            <div id="dvdash" runat="server" style="position: relative; height: 450px; width: 920px;
                overflow: auto;">
                <asp:GridView ID="gvFresh" runat="server" AutoGenerateColumns="false" GridGroups="both"
                    Width="98%" Height="100%" ShowHeader="false" RowStyle-CssClass="gridbgcolor">
