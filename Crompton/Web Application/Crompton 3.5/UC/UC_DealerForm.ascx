<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_DealerForm.ascx.cs"
    Inherits="UC_UC_DealerForm" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<table width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td class="headingred" colspan="2" align="center">
                                        ...
                                        <td colspan="2">
                                            <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="320px">
                                                        <asp:TextBox ID="txtFirstName" runat="server" CssClass="txtboxtxt" Width="165px"
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtLastName" runat="server" CssClass="txtboxtxt" Width="165px" MaxLength="20"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtLastName"
                                                            ErrorMessage="Last Name is required." SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:ImageButton ID="imhbtnsearch" Visible="false" Style="vertical-align: inherit;"
                                                            CausesValidation="false" ImageUrl="~/images/Search-icon.png" runat="server" OnClientClick="funOpenDivCS();" />
                                                        ...
                                                        <asp:RequiredFieldValidator ID="reqCityOther" runat="server" SetFocusOnError="true"
                                                            Display="None" ErrorMessage="Other City is required." ControlToValidate="txtOtherCity"></asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        <%--<asp:RequiredFieldValidator ID="rvtxtPinCode" runat="server" SetFocusOnError="true"
                                                                ControlToValidate="txtPinCode" ErrorMessage="Pincode is required." Display="None"></asp:RequiredFieldValidator>--%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList Width="205px" ID="ddlLanguage" runat="server" CssClass="simpletxt1">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtContactNo" MaxLength="11" Width="200px" runat="server" CssClass="txtboxtxt"></asp:TextBox>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtExtension" MaxLength="5" Width="165px" runat="server" CssClass="txtboxtxt"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 28%">
                                                        <asp:TextBox runat="server" MaxLength="11" Width="200px" ID="txtAltConatctNo" CssClass="txtboxtxt"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <asp:TextBox ID="txtEmail" MaxLength="60" runat="server" CssClass="txtboxtxt" Width="200px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtFaxNo" runat="server" Width="200px" CssClass="txtboxtxt" MaxLength="11"></asp:TextBox>
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" colspan="2">
                                                        <!--SRF.(Tick if yes)&nbsp;-->
                                                        <asp:CheckBox ID="chkSRF" Checked="false" Visible="false" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td valign="top">
                                                    ...
                                                    <td colspan="3">
                                                        <asp:TextBox ID="txtComplaintDetails" runat="server" CssClass="txtboxtxt" Width="350px"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" colspan="2">
                                                        Purchase Date&nbsp;
                                                        <asp:TextBox MaxLength="10" runat="server" ID="txtxPurchaseDate" CssClass="txtboxtxt" /><asp:CompareValidator
                                                            ID="CompareValidator7" runat="server" Type="Date" Operator="DataTypeCheck" ControlToValidate="txtxPurchaseDate"
                                                            Display="None" ErrorMessage="Valid Purchase date is required. "></asp:CompareValidator>
                                                ...
                                                <tr class="hideRow" style="height: 0px">
                                                    ...
                                                    <td colspan="3">
                                                        <asp:DropDownList Width="15px" Height="0px" ID="ddlSC" runat="server" CssClass="simpletxt1"
                                                ...
                                                <tr style="height: 20px">
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <br />
                                                        <span style="color: Red;">(File size should not be more than 4 MB and format should
                                                            be PDF, JPG, BMP, etc.)</span>
                                                    </td>
                                                    <td>
