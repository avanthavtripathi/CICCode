...
<%--<asp:GridView ID="GvNReport1" runat="server" AutoGenerateColumns="false" RowStyle-Height="40px"  >
<Columns>
...
<asp:TemplateField  HeaderText="Open Balance at the End of previous Month"> 
<ItemTemplate>
<asp:Label ID="lblopen" runat="server" Text='<%# Eval("LastMonthOpen")%>' > </asp:Label>
</ItemTemplate>
</asp:TemplateField>

<asp:TemplateField  HeaderText="Complaint Received Current Month"> 
<ItemTemplate>
<asp:Label ID="lblopen" runat="server" Text='<%# Eval("LastCount")%>' > </asp:Label>
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField  HeaderText="Total Complaints"> 
<ItemTemplate>
<asp:Label ID="lblopen" runat="server" Text='<%# Eval("TotalForMonth")%>' > </asp:Label>
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField  HeaderText="Complaint Closed in the Month"> 
<ItemTemplate>
...
<%--<asp:TemplateField HeaderText="Open Balance Complaints">
<ItemTemplate>
<div id="Label1" runat="server" style="width:279px;height:50px;word-break:break-all;overflow:auto;font-size:9px;" >
<%# Eval("ComplaintNos")%>
</div>
