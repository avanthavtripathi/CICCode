...
/// </summary>
public class ServiceContractorAction
{
    SqlDataAccessLayer objSqlDataAccessLayer = new SqlDataAccessLayer();
    CommonClass objCommonClass = new CommonClass();
    public ServiceContractorAction()
    {
        //
    ...
    public DataSet BindCompGrid(GridView gvFresh)
    {
        ...
        {
            gvFresh.Columns[9].HeaderText = "LoggedBy";
        }
        return ds;
    }
    ...
    public void BindServiceEngineer(DropDownList ddl)
    {
        ...
        //Getting values of Country to bind department drop downlist using SQL Data Access Layer 
        dsServiceEngineer = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspBaseComDet", sqlParamS);
    ...
    public int CheckClosedComplaintThroughSMS(string Complaint_RefNo, int SplitComplaint_RefNo)
    {
        int intReturn = 0;
        try
        {
