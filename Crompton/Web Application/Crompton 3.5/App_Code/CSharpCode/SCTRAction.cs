...
public class SCTRAction
{
    ...
    public int Reason // add by Vt
    { get; set; }
    public DateTime? DateVisit // add by Vt
    { get; set; }
    public string HappyCode // add by Vt
    { get; set; }
	...
	public void InsertAllocation()
	{
		SqlParameter[] sqlParamI =
		{
		  ...
		  // new SqlParameter ("@visitDate",this.DateVisit), 
    ...
    public void ActionEntry()
    {
            ...
            SqlParameter[] sqlParamI =
        {
           ...
           new SqlParameter("@DateVisit" ,this.DateVisit),
           new SqlParameter("@HappyCode" ,this.HappyCode),
		};
			sqlParamI[0].Direction = ParameterDirection.Output;
			sqlParamI[1].Direction = ParameterDirection.ReturnValue;
			//objSqlDataAccessLayer.ExecuteNonQuery(CommandType.StoredProcedure, "uspBaseComDet", sqlParamI);
