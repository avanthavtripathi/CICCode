...
public class CommonClass : System.Web.UI.Page
{
   ...
   // Bhawesh 8 jan 13
	...
	//// over load SendSMS function added by @VT 18/april2017
	...
	//							 };
	//		strInsertSmsQuery = "INSERT INTO SMS_TRANS (Complaint_RefNo,Receiver_Id,ReceiverType,MESSDATE,MFROM,MTO,MESS,FULLMESS,STATUS,happycode) VALUES(@Complaint_RefNo ,@Receiver_Id,@ReceiverType,@MDateYYYYMMDD,@MFrom4Char,@MobileNo,@MText166Char,@FULLMESS,@Status,@happycode)";
