...
public class SpareConsumption
{
    ...
    public DataSet BindData(GridView grv)
    {
        ...
        dstData = objCommonClass.BindDataGrid(grv, "uspRPTSpareConsumption", true, sqlParamSrh, true);
        return dstData;
    }
    ...
    public void BindRegionData(DropDownList ddl)
    {
        ...
        DataSet ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspRPTSpareConsumption", param);
        ddl.DataSource = ds;
    ...
    public void BindProductLine(DropDownList ddl,int intProductDibisionId)
    {
        SqlParameter[] param ={
                                new SqlParameter("@Type","FILL_PRODUCT_LINE_BY_DIVISION"),
                                new SqlParameter("@ProductDivision_Id",intProductDibisionId)
                             };
        DataSet ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspRPTSpareConsumption", param);
        ddl.DataSource = ds;
    ...
    // Created By bhawesh 16-8-13 , Aug-13 task List
    public void BindDefectiveSpareConsumptionReport(GridView GV)
    {
        SqlParameter[] sqlParamSrh =
        {
            new SqlParameter("@MessageOut",SqlDbType.VarChar,200),
            new SqlParameter("@Region_SNo",this.Region_Sno),
            new SqlParameter("@Branch_SNo",this.Branch_SNo),
            new SqlParameter("@Unit_SNo",this.ProductDivision_Id),
            new SqlParameter("@FromDate",this.From_Date),
            new SqlParameter("@ToDate",this.To_Date),
            new SqlParameter("@SC_SNo",this.ASC_Id)
        };
        sqlParamSrh[0].Direction = ParameterDirection.Output;
        objCommonClass.BindDataGrid(GV, "uspSpareConsumptionReport", true, sqlParamSrh,false);
        sqlParamSrh = null;
    }
