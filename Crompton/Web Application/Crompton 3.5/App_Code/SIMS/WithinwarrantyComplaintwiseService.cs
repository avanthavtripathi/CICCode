...
/// </summary>
public class WithinwarrantyComplaintwiseService
{
    SIMSSqlDataAccessLayer objSqlDataAccessLayer = new SIMSSqlDataAccessLayer();
    SIMSCommonClass objCommonClass = new SIMSCommonClass();
    DataSet dstData;
    public WithinwarrantyComplaintwiseService()
	{}
    ...
    public DataSet BindData(GridView grv)
    {
        ...
        dstData = objCommonClass.BindDataGrid(grv, "uspRPTWithinwarrantyComplaintwiseServicecost", true, sqlParamSrh, true);
        return dstData;
    }
    ...
    public void BindRegionData(DropDownList ddl)
    {
        ...
        DataSet ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspRPTWithinwarrantyComplaintwiseServicecost", param);
        ddl.DataSource = ds;
