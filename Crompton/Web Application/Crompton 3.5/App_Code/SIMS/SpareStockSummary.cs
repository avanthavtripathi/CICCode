...
public class SpareStockSummary
{
    ...
    public DataSet BindData(GridView grv)
    {
        ...
        dstData = objCommonClass.BindDataGrid(grv, "uspRPTSpareStockSummary", true, sqlParamSrh, true);
        return dstData;
    }
    ...
    public void BindRegionData(DropDownList ddl)
    {
        ...
        DataSet ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspRPTSpareStockSummary", param);
        ddl.DataSource = ds;
