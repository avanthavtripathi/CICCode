...
public class PendingDefectiveSpare
{
    ...
    public DataSet BindData(GridView grv)
    {
        ...
        dstData = objCommonClass.BindDataGrid(grv, "uspRPTPendingDefectiveSpare", true, sqlParamSrh, true);
        return dstData;
    }
    ...
    public void BindRegionData(DropDownList ddl)
    {
        ...
        DataSet ds = objSqlDataAccessLayer.ExecuteDataset(CommandType.StoredProcedure, "uspRPTPendingDefectiveSpare", param);
        ddl.DataSource = ds;
